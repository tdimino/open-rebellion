...
| P24 | Tactical space combat | Placement, selection, formations, movement, focus fire, pause/speed, retreat, visual state, accepted formulas, and galaxy result application. [Per-hull/fighter result identity and shared entry](evidence/2026-09-12-tactical-result-identity.md) are verified partial tranches. P54 through P57B2C2B stage and decode the original 3D corpus and recover its camera, placement, transform, palette, light, and retained-mode state. [P58A](../2026-09-10-interface-parity-audit/evidence/2026-09-14-tactical-resource-join.md) joins every ship and fighter DAT identity to its original resources and transports all 87 meshes and 397 textures. [P58B](../2026-09-10-interface-parity-audit/evidence/2026-09-14-tactical-production-participants.md) renders live capital ships from exact joined families. [P58C](../2026-09-10-interface-parity-audit/evidence/2026-09-14-tactical-fighters-selection.md) renders source fighter detail resources and aligns capital selection and targeting with projected mesh bounds. [P58D](../2026-09-10-interface-parity-audit/evidence/2026-09-14-tactical-fighter-detail-journey.md) proves the complete fighter-detail journey. [P58E](../2026-09-10-interface-parity-audit/evidence/2026-09-14-tactical-group-presentation.md) restores task-force and RGBY controls, group selection, keyboard routes, and selected fighter portraits. Original view acceptance, automatic group distribution, return, broader interactions, and battle acceptance remain open. |
