...
| P24 | Tactical space combat | Placement, selection, formations, movement, focus fire, pause/speed, retreat, visual state, accepted formulas, and galaxy result application. [Per-hull and fighter-roster result identity](evidence/2026-09-12-tactical-result-identity.md) is a verified partial tranche; interface and battle acceptance remain open. |
