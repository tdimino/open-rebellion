...
| First original tactical shell and control states; all original 3D assets decoded and transported; exact DAT resource joins; live capital families, fighter detail resources, system-selected planets, effects, fields, selected-capital damage, subsystem condition, exact field-source state, live subsystem damage, repair, maneuver state, physical integration, and authentic command assignment use recovered source contracts; other battle contents remain replacements | `crates/rebellion-render/src/tactical_view.rs`, `crates/rebellion-render/src/tactical_resources.rs`, `crates/rebellion-render/src/tactical_assets.rs`, `crates/rebellion-render/src/bmp_cache.rs`, `tools/stage-ui-assets` | Manual pp. 139–150, original TACTICAL resources, [P52 through P58F9 evidence](evidence/README.md), and [P58F9 evidence](evidence/2026-09-17-tactical-command-assignment.md) |
...
states, and selected-unit commit and cancel behavior. Order execution, turning,
...
through P58F9 restore system-selected planets, effects, fields,
...
position integration, and authentic command assignment; see the
[P58F9 evidence](evidence/2026-09-17-tactical-command-assignment.md).
