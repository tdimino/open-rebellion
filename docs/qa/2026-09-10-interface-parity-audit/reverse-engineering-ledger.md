...
source-shaped controls, disabled states, and commit/cancel delivery. Exact
global RNG sequencing, order execution, turning, collision and formation
behavior, power allocation, and original visual acceptance remain open.
