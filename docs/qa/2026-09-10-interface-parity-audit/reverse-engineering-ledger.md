...
| RE-TAC-02 | Tactical control geometry and resource-state selection | static-partial; complete corpus decoded/transported; exact DAT joins plus live capital-family rendering, camera, placement, authored transform, palette, light, and retained-mode device/material state source-proven/browser-rendered | Follow the [ranked recovery map](../../reference/space-battle-launcher/reverse-engineering-map.md) through fighter rendering, selection framing, and A0 comparison |
