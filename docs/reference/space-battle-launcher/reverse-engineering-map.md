...
| 6 | `FUN_005bae60`; `FUN_005ba980`; `FUN_005bad50`; `FUN_005ba520`; vtable `0x0066c748`; audio-manager callers; TACTICAL WAVE `13000`–`13065`; TEXTTACT `MDATA.401`–`MDATA.406` | P58-B15 stages MDATA.307 and proves event `0x14` routes to WAVE 13054. Recover the remaining event-to-SFX and voice mappings, faction variants, ducking, interruption, and native audible comparison. |
...
- [`FUN_005c2e60`](../../../ghidra/notes/FUN_005c2e60.c) selects and realizes a
  ...
  `13065`); P58-B15 stages source-identified WAVE 13054, while the other event
  and voice mappings remain open.
...
- `FUN_005bae60`, `FUN_005ba980`, `FUN_005bad50`, and `FUN_005ba520` establish
  the tactical audio manager, four-variant selection, and event `0x14` to WAVE
  13054. MDATA.307 supplies the battle score.
