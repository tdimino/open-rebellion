...
| 4 | `FUN_005ab650`, `FUN_005a9030`, `FUN_005adfa0`, `FUN_005c1100`, `FUN_005c12a0`, `FUN_00595be0`, `FUN_005c1080`, `FUN_005d9640`, `FUN_005c7150`, `FUN_005c63f0`, `0x005d4af0`; preserve `SYSTEMSD.picture_id` | Production placement on the recovered force-dependent extent and lanes, fighter groups, bounds, planet selection, resource family, production camera distance, and stable selected-object frame binding. Authored coordinates and handedness are proven in P57B2C1, live capital-family drawing in P58B, and fighter detail resources plus projected capital interaction in P58C. |
...
- The current fixture selects exact system DAT identities for its two faction
  ...
  triplets and projection-aligned capital interaction.
...
- `FUN_005c63f0` loads close, far, and indicator fighter resources;
  ...
  P58C implements and browser-proves that bounded contract.
