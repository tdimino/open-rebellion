...
- `FUN_005ad750` and `FUN_005afb70` establish the maneuver-state bonus.
  ...
  assignment boundary. Exact global RNG sequencing, order execution, turning,
  collision and formation behavior remain open.
