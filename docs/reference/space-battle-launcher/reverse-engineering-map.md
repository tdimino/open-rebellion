...
| 6 | `FUN_005a7500`; `FUN_005bae60`; `FUN_005ba980`; `FUN_005bad50`; `FUN_005ba520`; `FUN_005b3f10`; vtable `0x0066c748`; audio-manager callers; TACTICAL WAVE `13000`–`13065`; TEXTTACT `MDATA.401`–`MDATA.406` | P58-B15 stages MDATA.307. P58-B16 maps weapon events `0x0d–0x14` to all 22 WAVE `13033–13054` variants and emits them from production combat. Recover remaining non-weapon events and voice mappings, exact shared-RNG sequencing, faction variants, ducking, interruption, and native audible comparison. |
