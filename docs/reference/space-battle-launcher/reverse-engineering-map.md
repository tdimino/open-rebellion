...
- `FUN_005ad750` and `FUN_005afb70` establish the maneuver-state bonus.
  ...
  contracts. Exact global RNG sequencing, interactive command delivery,
  turning, collision and formation behavior remain open.
