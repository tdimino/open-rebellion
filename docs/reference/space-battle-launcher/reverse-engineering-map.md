...
| 6 | `FUN_005a7500`; `FUN_005bae60`; `FUN_005ba980`; `FUN_005bad50`; `FUN_005ba520`; `FUN_005b3f10`; vtable `0x0066c748`; audio-manager callers; TACTICAL WAVE `13000`–`13065`; VOICEFXA `14001`–`14122`, `15133`–`15163`; VOICEFXE `15001`–`15132`; TEXTTACT `MDATA.401`–`MDATA.406` | P58-B15 stages MDATA.307. P58-B16 maps and emits all 22 weapon variants. P58-B18 maps and transports all 285 faction voices and dispatches selected withdrawal/result/Death Star/trench-run transitions. Recover remaining completion/destruction/recovery/warning/ordered-trench callers, exact shared-RNG sequencing, ducking, interruption, and native audible comparison. |
...
- `FUN_005bae60` establishes a continuous tactical voice table: Alliance
  ...
  and RGBY trench-run transitions. Remaining completion, destruction,
  recovery, warning, and ordered trench callers remain open.
...
- `FUN_005ad750` and `FUN_005afb70` establish the maneuver-state bonus.
  ...
  class, and clear exhausted lists. P58-B06 adds the recovered weapon,
  collision, automatic group, forward-relative formation, exact strategic
  roster, officer-capture, and Death Star-state contracts. Exact global RNG
  sequencing, original arrival callbacks and recovery trajectories, power
  allocation, native beam behavior, native playback, and shared post-battle
  bombardment, landing, and navigation orchestration remain open.
