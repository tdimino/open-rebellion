...
- `FUN_005ad750` and `FUN_005afb70` establish the maneuver-state bonus.
  ...
  Returning state 2. Exact global RNG sequencing, turning and waypoint
  completion, full fighter recovery, attack executors, collision and formation
