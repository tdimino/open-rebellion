...
| [Space-battle graphics](space-battle.md) and [native tactical lookup](tactical-lookup.json) | Tactical BMP groups, exact DAT-to-ordinal mesh/texture joins, first source-proven three-LOD rule and cached-slot cycle, and remaining effects | 29 ship, eight fighter, and Death Star joins proven; complete corpus transported; live production capital families render with the recovered camera, placement, palette, light, and device/material state; fighters and special objects remain open |
