...
| [Space-battle graphics](space-battle.md) and [native tactical lookup](tactical-lookup.json) | Tactical BMP groups, exact DAT-to-ordinal mesh/texture joins, source-proven LOD and fighter-detail rules, group presentation, projected interaction, subsystem condition, and field-source identity | 29 ship, eight fighter, and Death Star joins proven; complete corpus transported; live capitals, fighters, groups, effects, fields, selected damage, and five subsystem families render through recovered contracts; combat-driven subsystem damage, automatic grouping, and special objects remain open |
