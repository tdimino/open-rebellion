...
| [Space-battle graphics](space-battle.md) and [native tactical lookup](tactical-lookup.json) | Tactical BMP groups, exact DAT-to-ordinal mesh/texture joins, source-proven LOD and fighter-detail rules, group presentation, projected interaction, subsystem condition, field-source identity, and live damage | 29 ship, eight fighter, and Death Star joins proven; complete corpus transported; live capitals, fighters, groups, effects, fields, selected damage, five subsystem families, and source-derived damage render through recovered contracts; repair, movement effects, automatic grouping, and special objects remain open |
