...
| [Space-battle graphics](space-battle.md) and [native tactical lookup](tactical-lookup.json) | Tactical BMP groups, exact DAT-to-ordinal mesh/texture joins, source-proven LOD and fighter-detail rules, group presentation, projected interaction, and remaining effects | 29 ship, eight fighter, and Death Star joins proven; complete corpus transported; live capitals, the full fighter detail journey, and task-force/RGBY controls render through the recovered scene contract; automatic grouping, damage, and special objects remain open |
