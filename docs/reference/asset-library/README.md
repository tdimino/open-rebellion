...
| [Space-battle graphics](space-battle.md), [native tactical lookup](tactical-lookup.json), and [tactical voice map](tactical-voice-map.json) | Tactical BMP groups, exact DAT-to-ordinal mesh/texture joins, source-proven LOD and fighter-detail rules, group presentation, projected interaction, subsystem condition, field-source identity, live damage, and all 285 faction voice resources | 29 ship, eight fighter, and Death Star joins proven; complete visual and voice corpora transported; live capitals, fighters, groups, effects, fields, selected damage, five subsystem families, and recovered tactical voice transitions render or route through source-backed contracts; remaining production voice families and strict A0 acceptance stay open |
