...
| Battle meshes and textures | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources | P54 raw staging and P55 deterministic decoding are implemented; P56 packages and renders the exact `2560/1033` plus `SDESTI52.BMP/1033` pair in an isolated browser proof. Complete transport, original view rules, production integration, and semantic mapping remain open |
