...
| Battle audio                             | Original `TACTICAL.DLL` contains 66 WAVs; events `0x0d–0x14` map to 22 weapon variants at `13033–13054`. VOICEFXA/VOICEFXE supply 90 restored battle-ready and group command WAVs | P58-B16 proves exact weapon extraction and dispatch. P58-B17 proves faction battle-ready and task-force/RGBY maneuver, attack, formation, and mission selection, extraction, runtime-pack transport, and muted browser routing. Remaining result/withdrawal/Death Star voice events, exact shared-RNG sequencing, mixing, interruption, audible native comparison, and A0 acceptance remain open |
