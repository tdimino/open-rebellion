...
original X slots, and targets the selected source world coordinate. See the
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Capital ships                            | 30 CAPSHPSD classes; 29 native ordinal → type-301 bases `2010`–`2150` and `2510`–`2640`, plus separate Death Star `5010`/`5020`                  | P58A proves every DAT identity join. P58B installs the complete corpus and renders joined production capital families at source positions. Selection framing, damage, and exhaustive family views remain open                                                                                                                   |
| Fighters                                 | Eight FIGHTSD classes; eight native ordinals `29`–`36` → paired type-303 bases `4000`–`4134`                                                     | P58A proves every DAT identity join; P58C owns production sprite rendering, side/formation offsets, selection, launch/recovery, and damage                                                                                                                                                |
...
| Battle meshes and textures               | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources                                                   | P54 through P58B prove staging, deterministic decoding, full browser transport, exact DAT joins, live capital-family rendering, LOD, camera, placement, authored coordinates, palette, lighting, filtering, culling, depth, and material/device state. Lossless view acceptance remains open |
...
positions. Fighter sprites, special objects, selection presentation, and
