...
| Battle meshes and textures               | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources                                                   | P54 through P58F7 prove staging, deterministic decoding, full browser transport, exact DAT joins, and live capital, fighter, planet, target-effect, projectile, field, selected-capital damage, subsystem condition, combat-driven condition, repair, and mobility rendering. Lossless view acceptance remains open |
...
active tractor-drag mobility. Automatic group distribution, exact planet
placement, exact global RNG sequencing, maneuver-mode production, physical
movement integration, interactive commands, power allocation, special objects,
