...
| Battle meshes and textures               | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources                                                   | P54 through P58C prove staging, deterministic decoding, full browser transport, exact DAT joins, live capital and fighter rendering, LOD, camera, placement, projection, palette, lighting, filtering, culling, depth, and material/device state. Lossless view acceptance remains open       |
...
projected mesh bounds. Squadron and task-force panels, special objects,
close/far journeys, and original-runtime confirmation remain required before
