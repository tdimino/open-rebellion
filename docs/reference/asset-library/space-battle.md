...
| Battle meshes and textures               | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources                                                   | P54 through P58D prove staging, deterministic decoding, full browser transport, exact DAT joins, live capital and fighter rendering, LOD, camera, placement, projection, palette, lighting, filtering, culling, depth, material/device state, and fighter detail transitions. Lossless view acceptance remains open       |
...
proves the live fighter transition journey. Squadron and task-force panels,
