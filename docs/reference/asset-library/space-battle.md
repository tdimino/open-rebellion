...
| Battle meshes and textures | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 textures | Not extracted by the current stage tool, not in the runtime pack, and not semantically mapped |
