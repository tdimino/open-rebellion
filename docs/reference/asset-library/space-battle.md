...
| Battle meshes and textures               | Original `TACTICAL.DLL` contains 87 type-301 meshes and 397 type-303 texture/palette resources                                                   | P54 through P58F6 prove staging, deterministic decoding, full browser transport, exact DAT joins, and live capital, fighter, planet, target-effect, projectile, field, selected-capital damage, subsystem-condition, and combat-driven condition rendering. Lossless view acceptance remains open |
...
cancellation. Automatic group distribution, exact planet placement, exact RNG
sequencing, repair, movement effects, interactive commands, power allocation,
