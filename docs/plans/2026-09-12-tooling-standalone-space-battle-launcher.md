...
the target camera to the selected source-world point. The DAT-to-resource join,
production 3D draw path, remaining render rules, task-force and squadron
