...
Status: the P52, P53, P57B2A, P57B2B1, and P57B2B2 slices pass this scoped gate for shell `1000`, faction
...
replacement panels are removed. Stable production identity and position
binding, remaining render rules, task-force and squadron
