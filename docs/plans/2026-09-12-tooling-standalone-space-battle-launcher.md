...
Status: the P52, P53, P57B2A, and P57B2B1 slices pass this scoped gate for shell `1000`, faction
...
normal/held resources and focuses the selected fixture object. The active
combat replacement panels are removed. General layout, stable production
identity and position binding, remaining render rules, task-force and squadron
