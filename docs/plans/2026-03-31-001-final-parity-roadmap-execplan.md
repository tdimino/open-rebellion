...
- [x] (2026-09-10) Completed the F-007E conquest checkpoint: save-v13 fleet cargo enforces living transport capacity, survives transit and consolidation, lands after orbital control, continues unresolved surface battles, persists tactical casualties, occupies systems, captures enemy characters, and makes HQ victory depend on occupation. Five 5,000-tick runs now exercise the full invasion chain. All 567 workspace tests, exact native/WASM replay, and Astra-medium two-faction bitmap/browser gates pass with no P0/P1 blocker. Player troop commands, balance, battle spread, complete victory targeting, and five-seed cross-runtime replay remain open. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-10-troop-transport-occupation.md`.
...
- Observation: F-007E now completes the mechanical conquest chain and exposes strategic targeting and balance as the next campaign boundary.
  Evidence: five current runs carry and land 8–15 regiments, resolve 6–9 ground engagements, and emit 5–6 character captures. They still produce only 10–19 combined space/ground engagements and no run acquires every randomized Standard victory target.
...
| A2 | AI | P1 | Finish troop deployment parity: expose player embark/disembark commands and refine transport-backed AI target selection until it reaches all Standard victory objectives. | F-007E now carries troops through `AIAction::MoveFleet`, transit, landing, occupation, and capture. Five-seed runs still miss complete randomized victory targets, and the player has no direct troop command. | 160-260 | A1 helpful | Yes |
