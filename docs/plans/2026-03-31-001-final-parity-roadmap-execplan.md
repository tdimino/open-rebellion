...
> Independent browser and design reviews found additional persistence,
...
- [x] (2026-09-08) Replaced the approximate fleet-list icon offset with exact mappings for all 38 fighter and capital-ship classes; independent browser run R9 passed the browser bitmap and interaction gate. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-08-fleet-miniatures.md`.
- [x] (2026-09-08) Shipped deterministic `runtime.orpk` with 52 game-data entries and 2,231 BMPs. Independent browser run R6 passed both factions with four cold-load requests, zero loose asset requests, correct transparent fleet art, working interactions, and no errors across twenty zoom steps. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-08-runtime-pack.md`.
- [x] (2026-09-08) Added F-011A canonical save-state fingerprints and v9 integrity metadata. The seeded two-run probe passes; independent browser run R3 passed 34 browser save/reload/load, lossless metadata, bitmap, network, and error assertions. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-08-state-fingerprints.md`.
- [x] (2026-09-09) Added the F-011B1 save v10 continuation envelope, deterministic populated typed-map fingerprints, and real-v9-artifact migration. All 483 workspace tests passed; independent browser run R2 passed 40/40 browser storage, reload, continuation, bitmap, network, and error assertions. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-state-continuation.md`.
- [x] (2026-09-09) Closed F-001 browser Save/Load/Delete wiring and fixed empty-slot Load activation found by browser review R1. All 486 workspace tests passed; independent browser run R2 passed 33/33 deletion, persistence, bitmap, network, and error assertions. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-save-delete.md`.
- [x] (2026-09-09) Replaced the browser custom text menu and visible setup page with the binary-mapped shuttle cockpit, direct faction start, and single-loop original menu music. Independent browser run R2 exercised the full browser matrix and R3 passed the corrected 11/11 commit gate. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-main-menu-cockpit.md`.
- [x] (2026-09-09) Added F-016B campaign configuration persistence in save v11 and enforced Standard principal-leader capture versus Headquarters Only victory rules. All 495 workspace tests passed; independent browser run R2 passed 18/18 browser setup, reload, bitmap, storage, network, and error assertions. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-game-setup-propagation.md`.
- [x] (2026-09-09) Completed F-016C: Credits, explicit M4 multiplayer status, gain/mute, return-to-menu, clean second-campaign reset, exact `MDATA.300` *Return of the Jedi* cue, and original `COMMON.DLL` menu effects. All 500 tests and native build/startup pass; independent browser completion evidence is in `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-main-menu-completion.md`. Native interactive visual acceptance and semantic canvas accessibility remain P03 release-hardening work; P04 is complete.
- [x] (2026-09-09) Completed F-016D browser semantic accessibility without altering the bitmap-only cockpit. All 502 tests pass; independent browser review passed nine of nine browser gates, 84/84 focus transitions, all 14 controls, every destination, `MDATA.300`, and all four original effects with four requests and zero runtime errors. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-main-menu-semantics.md`. F-016E then closed the native visual gate.
- [x] (2026-09-09) Completed F-016E and P03. The binary reference proves the original had no standalone mute control; Open Rebellion now adds one documented 30×22 music-only extension styled from the Jiff Gorda/SWG Project Thorn reference. Native presentation was accepted, all 504 tests pass, and independent browser review passed 10/10 browser gates across four viewports with exact hit/paint bounds, music muted after its initial-state assertion, SFX preserved, and zero errors. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-main-menu-music-toggle.md`.
...
- [x] (2026-09-09) Added F-011B4 exact-artifact native/WASM replay equivalence. The 13,482-byte seed-42 artifact produces the same initial fingerprint, nine checkpoints, tick-25 final fingerprint, and artifact text in both runtimes; independent browser review passed success, invalid-query, missing-pack, and normal four-request browser gates with zero errors. F-007B intentionally updated tick-10 onward state, and the re-reviewed artifact passes all 530 workspace unit tests plus native/WASM equivalence. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-replay-wasm-equivalence.md`.
- [x] (2026-09-09) Completed F-007A: active movement orders cannot be replaced, AI fleet selection excludes transit and same-pass reservations, and rejected AI moves produce no false telemetry, movement message, or departure audio. The seed-42 5,000-tick run cut attack orders from 306,012 to 78,946 and reached 1.006 accepted moves per arrival. Independent browser review passed both faction bitmap paths with four requests and zero errors. Fleet creation, arrival merging, combat backlog, and victory remain open under F-007. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-fleet-redispatch.md`.
- [x] (2026-09-09) Completed F-007B: accepted departures leave their origin index, stale indexes reconcile before production, and compatible anonymous arrivals consolidate deterministically while character and Death Star task forces remain distinct. Five 5,000-tick seeds now keep fleet arenas at or below 1.4 times their initial size and moves at or below 1.002 times arrivals. Native/WASM replay, 530 workspace tests, and independent bitmap browser acceptance pass. Ordinary player dispatch, transit balance, combat distribution, and victory remain open. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-fleet-position-consolidation.md`.
- [x] (2026-09-09) Completed F-007C: the bitmap galaxy and fleet panel now issue validated player movement through the authoritative departure path, remove the fleet from its origin, show destination and countdown without overlap, and prevent repeat dispatch. The final independent browser review pass found no P0-P3 issue across Alliance and Empire, with four requests per faction and zero runtime or asset errors. All 533 workspace tests and exact native/WASM replay pass. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-player-fleet-dispatch.md`.
- [x] (2026-09-10) Completed F-007D: every hostile task force at a system now enters one bounded engagement; fighter losses persist; local wings launch; shield handling and small-wing attrition make real progress; and unchanged stalemates do not reopen every five ticks. Seed 42 falls from 603 space events, including 602 recurring Xyquine draws, to two decisive engagements. All 541 workspace tests, exact native/WASM replay, five-seed diagnostics, and independent bitmap browser startup pass. F-007E retains the newly exposed AI balance, transit fan-in, repair telemetry, and victory failures. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-10-system-combat-resolution.md`.
...
- [ ] v1.0: deploy the complete browser build to Cloudflare Pages behind secret-backed password middleware and signed sessions, then pass independent browser acceptance for authentication, single-player, multiplayer, performance, and bitmap presentation against the deployed URL.
...
| Manifest-governed faithful-HD rollout from the [P45 plan](2026-09-10-faithful-hd-pipeline/) | The original shipped only the low-resolution art. HD assets are a value-add pack, not a parity requirement. | 50-150 code plus asset ops |
