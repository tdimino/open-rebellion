...
int __fastcall FUN_004e2c70(int param_1)

{
  ...
  if (bVar2) {
    ...
    if (((*(uint *)((int)pvVar4 + 0x28) & 3) == 0) && ((*(uint *)((int)pvVar4 + 0x28) & 0x80) != 0))
    {
      local_18 = 1;
    }
  }
  if (local_18 == 0) {
    ...
    puVar5 = FUN_00419b80(*(void **)(param_1 + 0x2c),puVar6,0x100,0,0,0,0,0,2);
    ...
    FUN_00619730();
    FUN_005f58b0(pvVar4);
    puVar5 = FUN_0041a400(*(void **)(param_1 + 0x2c),this,puVar6,0x80,0,0,3,0,0,
    ...
    FUN_00619730();
    if (!bVar2) {
      puVar5 = FUN_00419b80(*(void **)(param_1 + 0x2c),puVar6,0x800,0,0,0,0,0,2);
      FUN_00435790(pvVar4,(int)puVar5);
      puVar5 = FUN_004357b0(pvVar4,&local_14);
      local_4 = 2;
      FUN_004f26d0(this,puVar5);
      ...
      FUN_00619730();
      FUN_005f58b0(pvVar4);
      puVar6 = FUN_0041a400(*(void **)(param_1 + 0x2c),this,puVar6,0x40,0,0,3,0,0,
                            (undefined4 *)&DAT_00000002);
