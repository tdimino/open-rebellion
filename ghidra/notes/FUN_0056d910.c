...
undefined4 __cdecl FUN_0056d910(int param_1,undefined4 param_2,void *param_3,undefined4 *param_4)

{
  ...
  *param_4 = 0;
  ...
  while ((this_00 != (void *)0x0 && (*(int *)((int)this + 4) == -1))) {
    ...
    local_10 = 0x36;
    local_4 = 1;
    if ((*puVar2 >> 0x18 < 0x35) || (0x35 < *puVar2 >> 0x18)) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
