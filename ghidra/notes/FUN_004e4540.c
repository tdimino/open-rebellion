...
void __fastcall FUN_004e4540(int param_1)

{
  ...
  local_4._0_1_ = 2;
  local_44 = 0;
  FUN_004ece80((undefined4 *)(param_1 + 0x48));
  local_40 = FUN_004e4950(param_1);
  if (local_40 < 1) {
LAB_004e47bd:
    uVar6 = *(uint *)(param_1 + 0x48) >> 0x18;
    local_24 = 0x90;
    local_20 = 0x98;
    ...
    if (bVar1) {
      ...
      FUN_004f26d0(&stack0xffffffa0,(undefined4 *)(param_1 + 0x48));
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if (local_30 == (undefined1 *)0x0) {
          ...
          pvVar5 = FUN_004ecc70(local_30,(undefined4 *)(param_1 + 0x48));
        }
        local_4._0_1_ = 2;
        if (pvVar5 != (void *)0x0) {
          FUN_004f57b0((void *)(param_1 + 0x60),pvVar5);
          *(uint *)((int)pvVar3 + 0x28) = *(uint *)((int)pvVar3 + 0x28) | 0x1000000;
      ...
      bVar1 = false;
      uVar2 = FUN_005f50e0(param_1 + 0x60);
      if (uVar2 < 2) {
        pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x60);
        if (pvVar3 != (void *)0x0) {
          ...
          local_4._0_1_ = 2;
          FUN_00619730();
          if ((pvVar3 != (void *)0x0) && (0 < *(int *)((int)pvVar3 + 0x60))) {
            bVar1 = true;
          }
        }
        if (!bVar1) {
          iVar7 = FUN_0041b230(*(void **)(param_1 + 0x2c),(uint *)(param_1 + 0x50),(void *)0x2a,
                               0x10000,0x4000,2);
          if (iVar7 <= local_40) {
            *(uint *)(*(int *)(param_1 + 0x2c) + 8) = *(uint *)(*(int *)(param_1 + 0x2c) + 8) | 0x40
            ;
          }
        }
      }
  ...
  pvVar3 = FUN_00419a00(*(void **)(param_1 + 0x2c),0x80,0,0,0,0,0,0x15,(void *)0x1);
  ...
  do {
    ...
    while( true ) {
      ...
      if ((pvVar3 != (void *)0x0) && (0 < *(int *)((int)pvVar3 + 0xc4))) break;
      FUN_004ece80(&local_4c);
    }
    pvVar5 = FUN_0041a340(*(void **)(param_1 + 0x2c),&local_4c,0,0,1,0x3800003,0,0x40000000,6,
                          (void *)0x1);
    ...
    while( true ) {
      ...
      if (((pvVar5 != (void *)0x0) && (0 < *(int *)((int)pvVar5 + 0x60))) &&
         (*(int *)((int)pvVar5 + 0xd8) <= local_40)) {
        FUN_004f26d0((void *)(param_1 + 0x48),&local_48);
        local_44 = 1;
      }
