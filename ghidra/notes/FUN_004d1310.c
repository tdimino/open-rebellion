...
int * __fastcall FUN_004d1310(int param_1)
      ...
      if (*(int *)((int)pvVar6 + 0x5c) < 1) {
        ...
        *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) & 0xffbfffff;
        ...
        if (bVar3) {
          ...
          local_4 = 2;
          FUN_004f26d0((void *)(param_1 + 0x5c),puVar5);
          local_4 = 0xffffffff;
          FUN_00619730();
...
LAB_004d14c8:
    ...
    local_4 = 5;
    piVar7 = FUN_004f3220(*(int *)(param_1 + 0x30),(uint *)(param_1 + 0x5c));
    if (piVar7 != (int *)0x0) {
