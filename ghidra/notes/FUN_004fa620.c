...
int __thiscall FUN_004fa620(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar2 = FUN_0053a610(0x10,*(uint *)(iVar2 + 0x50),(uint *)((int)this + 0x50));
      if (iVar2 != 0) {
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
            local_4 = (**(code **)(*(int *)this + 0x188))
                                (*(uint *)((int)this + 0x50) >> 4 & 1,param_1);
          }
        }
      }
    }
