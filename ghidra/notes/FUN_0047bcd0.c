...
void __fastcall FUN_0047bcd0(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  ...
  if (sVar3 == 0) {
    pvVar4 = FUN_004035d0(*(void **)((int)param_1 + 100),0,2,0x800,0x7400051,0,2,10,10000,
                          (void *)0x1);
...
LAB_0047bdad:
        ...
        sVar3 = FUN_005f50e0(iVar1);
        if (sVar3 != 0) goto LAB_0047bdad;
        bVar2 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar2) goto LAB_0047be06;
