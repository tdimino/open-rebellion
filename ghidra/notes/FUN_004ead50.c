...
void __fastcall FUN_004ead50(int param_1)

{
  ...
  if (iVar4 != 0) {
    FUN_004f26d0(&local_34,(undefined4 *)(iVar4 + 0x1c));
  }
  if (0 < (int)uVar8) {
    uVar9 = 6;
    uVar8 = FUN_005f4960((undefined4 *)(*(int *)(param_1 + 0xc) + 4));
    if (((uVar8 & 0x400) != 0) && (*(int *)(param_1 + 4) == 2)) {
      pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0x80000408,0,0,0,0x4b,(void *)0x1);
    ...
    FUN_00619730();
    if (!bVar1) {
      pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0x408,0,0,0,0x4b,(void *)0x1);
      pvVar7 = (void *)(param_1 + 0x1c);
      FUN_00435790(pvVar7,(int)pvVar5);
      local_28 = (void *)0x80;
      local_24 = 0x90;
      if ((local_34 >> 0x18 < 0x80) || (0x8f < local_34 >> 0x18)) {
        bVar1 = false;
      }
      else {
        bVar1 = true;
      ...
      FUN_00619730();
      if (bVar1) {
        puVar6 = FUN_00419b80(*(void **)(param_1 + 0xc),&local_34,0,0,0x408,0,0,0,2);
        FUN_00435790(pvVar7,(int)puVar6);
      }
      if (local_30 != 0) {
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x408,0,0,0,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x408,0,0,0,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
      }
    ...
    FUN_00619730();
    if (!bVar1) {
      pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0x408,0,0,0,0x30,(void *)0x1);
      pvVar7 = (void *)(param_1 + 0x1c);
      FUN_00435790(pvVar7,(int)pvVar5);
      local_28 = (void *)0x80;
      local_24 = 0x90;
      ...
      FUN_00619730();
      if (bVar1) {
        puVar6 = FUN_00419b80(*(void **)(param_1 + 0xc),&local_34,0,0,8,0,0,0,2);
        FUN_00435790(pvVar7,(int)puVar6);
      }
      if (local_30 != 0) {
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x408,0,0,0,&DAT_00000002);
    ...
    if (!bVar1) {
      uVar9 = 1;
      pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0x80100,0,0,0,4,(void *)0x1);
      pvVar7 = (void *)(param_1 + 0x1c);
      FUN_00435790(pvVar7,(int)pvVar5);
      local_28 = (void *)0x80;
      local_24 = 0x90;
      ...
      FUN_00619730();
      if (bVar1) {
        puVar6 = FUN_00419b80(*(void **)(param_1 + 0xc),&local_34,0,0,0x80100,0,0,0,2);
        FUN_00435790(pvVar7,(int)puVar6);
      }
      if (local_30 != 0) {
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x80100,0,0,0,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x80100,0,0,0,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
      }
    ...
    if (!bVar1) {
      uVar9 = 5;
      pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0,0,0,2,3,(void *)0x1);
      pvVar7 = (void *)(param_1 + 0x1c);
      FUN_00435790(pvVar7,(int)pvVar5);
      local_28 = (void *)0x80;
      local_24 = 0x90;
      ...
      FUN_00619730();
      if (bVar1) {
        puVar6 = FUN_00419b80(*(void **)(param_1 + 0xc),&local_34,0,0,0,0,0,2,2);
        FUN_00435790(pvVar7,(int)puVar6);
      }
      if (local_30 != 0) {
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0,0,0,2,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
        pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0,0,0,2,&DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar5);
      }
    ...
    if ((bVar1) && (iVar4 = FUN_004e5260(local_18,(int *)&local_40), iVar4 == 0)) {
      ...
      if (local_2c == (void *)0x0) {
        ...
        pvVar7 = FUN_004ecac0(local_2c,&local_40,uVar9,0);
      }
      local_4._0_1_ = 2;
