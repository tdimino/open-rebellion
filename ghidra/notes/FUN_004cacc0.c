...
int __fastcall FUN_004cacc0(int param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x74) = 0;
  for (pvVar4 = (void *)thunk_FUN_005f5060(param_1 + 0x78); pvVar4 != (void *)0x0;
    ...
    if ((((pvVar6 != (void *)0x0) && ((*(byte *)((int)pvVar6 + 0x30) & 1) != 0)) &&
      ...
      *(int *)(param_1 + 0x74) = *(int *)((int)pvVar6 + 0x114);
  ...
  if (local_24 == 0) {
    ...
    sVar3 = FUN_005f50e0((int)pvVar6);
    if (sVar3 != 0) {
      pvVar7 = FUN_0041a340(*(void **)(param_1 + 0x2c),this,0,0,1,0x200003,0,0x40000000,0x33,
                            (void *)0x1);
      FUN_00435790(pvVar4,(int)pvVar7);
    }
    puVar5 = FUN_004357b0(pvVar4,&local_18);
