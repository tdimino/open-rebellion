...
int __thiscall FUN_00557ab0(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar2 = FUN_0053a610(2,*(uint *)(iVar2 + 0x5c),(uint *)((int)this + 0x5c));
      if (iVar2 != 0) {
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            local_4 = (**(code **)(*this + 0x238))(*(uint *)((int)this + 0x5c) >> 1 & 1,param_1);
          }
        }
      }
    }
