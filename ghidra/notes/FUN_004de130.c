...
int * __fastcall FUN_004de130(int param_1)

{
  ...
  if ((uVar3 & 0x10) != 0) {
    pvVar4 = FUN_00419e90(*(void **)(param_1 + 0x2c),0,0,0x1000000,0,0,0,&DAT_00000002);
    ...
    FUN_00619730();
    FUN_005f58b0(pvVar7);
    pvVar4 = FUN_0041a340(*(void **)(param_1 + 0x2c),this,0,0,0x10001,2,0,0,0x10,&DAT_00000002);
    FUN_00435790(pvVar7,(int)pvVar4);
    puVar5 = FUN_004357b0(pvVar7,&local_48);
    local_4._0_1_ = 2;
    FUN_004f26d0(this,puVar5);
    ...
    if (bVar1) {
      ...
      if (0 < local_5c) {
        puVar5 = FUN_00419b80(*(void **)(param_1 + 0x2c),this,0x80000,0,0x800,0,0,0,1);
        ...
        FUN_00619730();
        FUN_005f58b0(pvVar7);
        pvVar4 = FUN_0041a340(*(void **)(param_1 + 0x2c),puVar9,0x10000,0,0x4001,2,0,0x30000,0x13,
                              &DAT_00000002);
        FUN_00435790(pvVar7,(int)pvVar4);
        puVar5 = FUN_004357b0(pvVar7,&local_48);
        local_4._0_1_ = 4;
        ...
        FUN_00619730();
        if (!bVar1) {
          puVar5 = FUN_00419b80(*(void **)(param_1 + 0x2c),this,0x180000,0,0,0,0,0,1);
          FUN_00435790(pvVar7,(int)puVar5);
          puVar5 = FUN_004357b0(pvVar7,&local_48);
          local_4._0_1_ = 5;
          FUN_004f26d0(puVar9,puVar5);
          ...
          FUN_00619730();
          FUN_005f58b0(pvVar7);
          pvVar4 = FUN_0041a340(*(void **)(param_1 + 0x2c),puVar9,0x10010000,0,1,2,0,0x30000,0x13,
                                &DAT_00000002);
          FUN_00435790(pvVar7,(int)pvVar4);
          puVar5 = FUN_004357b0(pvVar7,&local_48);
          local_4._0_1_ = 6;
