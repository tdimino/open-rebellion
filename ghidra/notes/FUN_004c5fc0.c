...
void __thiscall FUN_004c5fc0(void *this,void *param_1,void *param_2)

{
  ...
  *(undefined4 *)((int)this + 0x2e) = *puVar3;
  iVar4 = FUN_00526550((int)pvVar1);
  if (iVar4 == 1) {
  ...
  while (local_10 != 0) {
    ...
    puVar2 = FUN_004025b0(this_00,(uint *)ppvVar6);
    local_4._0_1_ = 2;
    FUN_004c67f0(this,uVar5,puVar2,pvVar1);
