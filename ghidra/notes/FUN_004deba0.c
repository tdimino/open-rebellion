...
int * __fastcall FUN_004deba0(int param_1)

{
  ...
  FUN_004ece80(this);
  pvVar3 = FUN_00419a00(*(void **)(param_1 + 0x2c),0x40000,0,0,0,0,0,0x1e,&DAT_00000002);
  pvVar5 = (void *)(param_1 + 0x40);
  FUN_00435790(pvVar5,(int)pvVar3);
  puVar4 = FUN_004357b0(pvVar5,&local_48);
  local_4._0_1_ = 1;
  FUN_004f26d0(this,puVar4);
  local_4._0_1_ = 0;
  FUN_00619730();
  FUN_005f58b0(pvVar5);
  pvVar3 = FUN_0041a340(*(void **)(param_1 + 0x2c),this,0x2000,0,1,2,0,0,0x15,&DAT_00000002);
  FUN_00435790(pvVar5,(int)pvVar3);
  puVar4 = FUN_004357b0(pvVar5,&local_48);
  local_4._0_1_ = 2;
  FUN_004f26d0(this,puVar4);
  ...
  local_38 = 0x98;
  if ((*this >> 0x18 < 0x90) || (bVar1 = true, 0x97 < *this >> 0x18)) {
    bVar1 = false;
  }
  FUN_00619730();
  if (bVar1) {
    ...
    FUN_004f26d0(&stack0xffffff8c,this);
    pvVar3 = FUN_00403d30((void *)(iVar8 + 0x2c));
    if (pvVar3 != (void *)0x0) {
      local_5c = *(int *)((int)pvVar3 + 0x9c);
    }
    puVar4 = FUN_00419b80(*(void **)(param_1 + 0x2c),this,0x80000,0,0x1000,0,0,0,1);
    ...
    FUN_00619730();
    FUN_005f58b0(pvVar5);
    pvVar3 = FUN_0041a340(*(void **)(param_1 + 0x2c),puVar7,0x10000,0,0x8001,2,0,0x30000,0x13,
                          &DAT_00000002);
    FUN_00435790(pvVar5,(int)pvVar3);
    puVar4 = FUN_004357b0(pvVar5,&local_48);
    local_4._0_1_ = 4;
    ...
    FUN_00619730();
    if (!bVar1) {
      puVar4 = FUN_00419b80(*(void **)(param_1 + 0x2c),this,0x280000,0,0,0,0,0,1);
      FUN_00435790(pvVar5,(int)puVar4);
      puVar4 = FUN_004357b0(pvVar5,&local_48);
      local_4._0_1_ = 5;
      FUN_004f26d0(puVar7,puVar4);
      ...
      FUN_00619730();
      FUN_005f58b0(pvVar5);
      pvVar3 = FUN_0041a340(*(void **)(param_1 + 0x2c),puVar7,0x20010000,0,1,2,0,0x30000,0x13,
                            &DAT_00000002);
      FUN_00435790(pvVar5,(int)pvVar3);
      puVar4 = FUN_004357b0(pvVar5,&local_48);
      local_4._0_1_ = 6;
    ...
    if (bVar1) {
      iVar8 = *(int *)(param_1 + 0x2c);
      local_3c = &stack0xffffff8c;
      FUN_004f26d0(&stack0xffffff8c,puVar7);
      pvVar5 = FUN_00403d30((void *)(iVar8 + 0x2c));
      ...
      if ((piVar6 != (int *)0x0) && (pvVar5 != (void *)0x0)) {
        ...
        do {
          ...
          while (local_10 != 0) {
            ...
            puVar7 = FUN_00402d80(pvVar3,puVar9);
            local_4._0_1_ = 8;
            iVar8 = FUN_0042e190((void *)(*(int *)(param_1 + 0x2c) + 0x138),puVar7);
            local_4._0_1_ = 7;
            FUN_00619730();
            if ((*(uint *)(iVar8 + 0x18) & 0x2000) != 0) {
          ...
          if (pvVar5 == (void *)0x0) {
            ...
            if (pvVar3 == (void *)0x0) {
              ...
              puVar7 = FUN_004025b0(pvVar5,(uint *)&local_3c);
              bVar2 = true;
  ...
  if ((iVar8 != 0) && (local_50 = (int *)FUN_004f5cd0(0x201), local_50 != (int *)0x0)) {
