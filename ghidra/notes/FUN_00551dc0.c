...
uint __thiscall FUN_00551dc0(void *this,uint *param_1,uint *param_2,void *param_3,void *param_4)

{
  ...
  if (*(int *)((int)param_3 + 4) == -1) {
    uVar1 = FUN_005504d0(local_f0,*param_1 >> 0x18,1,param_3);
  }
  if (uVar1 != 0) {
    if (*(int *)((int)param_3 + 4) == -1) {
