...
int __thiscall FUN_0052f6b0(void *this,void *param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_00645350;
  local_c = ExceptionList;
  piVar5 = (int *)((int)this + 0x60);
  iVar8 = *(int *)((int)this + 0x70) - *(int *)((int)this + 100);
  bVar4 = true;
  iVar7 = 1;
  if (*piVar5 - *(int *)((int)this + 100) < iVar8) {
    iVar8 = *piVar5 - *(int *)((int)this + 100);
  }
  if (iVar8 != 0) {
    bVar3 = iVar8 < 1;
    if (bVar3) {
    ...
    if (iVar8 != 0) {
      while (bVar4) {
        bVar4 = false;
        this_00 = (void *)FUN_00506630();
        while ((iVar7 != 0 && (this_00 != (void *)0x0))) {
          if (iVar8 == 0) goto LAB_0052f8b2;
          if ((((*(byte *)((int)this_00 + 0x50) & 1) != 0) &&
              ((*(byte *)((int)this_00 + 0x60) & 1) == 0)) &&
             (((*(uint *)((int)this_00 + 0x24) ^ *(uint *)((int)this + 0x24)) & 0xc0) == 0)) {
            if (bVar3) {
...
LAB_0052f8b2:
    FUN_0052ed50(this,local_3c,param_1);
    local_4 = 0xffffffff;
    FUN_00619730();
  }
  ExceptionList = local_c;
