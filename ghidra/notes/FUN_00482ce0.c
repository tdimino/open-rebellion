...
void __fastcall FUN_00482ce0(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  ...
  if (uVar2 < 2) {
    pvVar3 = FUN_00403460(*(void **)((int)param_1 + 100),0x10800002,*(uint *)((int)param_1 + 0x7c),
                          0x47400051,0,5,0x33,10000,(void *)0x1);
    ...
    if (bVar1) {
      puVar5 = FUN_00403750(*(void **)((int)param_1 + 100),(undefined4 *)((int)param_1 + 0x38),
                            0x10800002,*(uint *)((int)param_1 + 0x7c),0x47400051,0,2);
...
LAB_00482e18:
        ...
        uVar2 = FUN_005f50e0((int)param_1 + 0x3c);
        if (1 < uVar2) goto LAB_00482e18;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_00482e76;
