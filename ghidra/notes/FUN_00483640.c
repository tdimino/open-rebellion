...
undefined4 __fastcall FUN_00483640(int *param_1)

{
  ...
  if (bVar2) {
    ...
    if (bVar2) {
      ...
      if (pvVar5 != (void *)0x0) {
        ...
        if (((*this == local_6c) && (uVar1 = *(uint *)((int)pvVar5 + 0x30), (uVar1 & 8) != 0)) &&
           (((uVar1 & 4) != 0 && ((uVar1 & 0x60) == 0)))) {
  ...
  if (!bVar2) {
    ...
    pvVar5 = FUN_00419a00((void *)param_1[0x1a],0,0x100,0,0,0,0,0x41,(void *)0x1);
    ...
    while( true ) {
      ...
      FUN_00619730();
      if (!bVar2) break;
      pvVar5 = FUN_0041a340((void *)param_1[0x1a],&local_68,0,0x1000,0,0,0,0,0x2f,(void *)0x1);
      ...
      pvVar5 = FUN_0041a340((void *)param_1[0x1a],&local_68,0,0x2000,0,0,0,0,0x2f,&DAT_00000002);
      FUN_00435790(local_1c,(int)pvVar5);
