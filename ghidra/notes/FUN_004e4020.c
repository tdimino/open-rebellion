...
int * __fastcall FUN_004e4020(int param_1)
      ...
      if (*(int *)((int)pvVar6 + 0x60) < 1) {
        ...
        *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) & 0xfeffffff;
        ...
        if (bVar3) {
          ...
          local_4 = 2;
          FUN_004f26d0((void *)(param_1 + 0x48),puVar5);
          local_4 = 0xffffffff;
          FUN_00619730();
...
LAB_004e41d8:
    ...
    local_4 = 5;
    piVar7 = FUN_004f3220(*(int *)(param_1 + 0x30),(uint *)(param_1 + 0x48));
    if (piVar7 != (int *)0x0) {
