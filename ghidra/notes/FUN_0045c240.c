...
void __thiscall FUN_0045c240(void *this,uint *param_1,int param_2,int param_3)

{
  ...
  puVar2 = param_1;
  iStack_4 = 0xffffffff;
  puStack_8 = &LAB_00630aa8;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  this_00 = (int *)FUN_00604500((void *)((int)this + 0x6c),(ushort)((short)*param_1 << 6) | 1);
  if (this_00 != (int *)0x0) {
    ...
    if ((param_1[0x14] & 8) == 0) {
      ...
      if (bVar1) {
        param_1 = (uint *)CONCAT22(DAT_0065d424,0x1822);
