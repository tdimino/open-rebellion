...
FUN_0041ae20(void *this,undefined4 *param_1,int param_2,uint param_3,uint param_4,undefined4 param_5
            )
    ...
    if (pvVar6 != (void *)0x0) {
      ...
      if (param_1 != (undefined4 *)0x0) {
        ...
        for (; pvVar6 != (void *)0x0; pvVar6 = *(void **)((int)pvVar6 + 0x10)) {
          if (((*(int *)((int)pvVar6 + 0x30) == param_2) &&
              ((param_3 & *(uint *)((int)pvVar6 + 0x38)) == param_3)) &&
             ((param_4 & *(uint *)((int)pvVar6 + 0x38)) == 0)) {
            puVar7 = FUN_00403040(pvVar6,&param_5);
            local_4._0_1_ = 3;
