...
void __fastcall FUN_0047d720(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffd;
  ...
  if ((int)(uint)uVar2 < iVar8) {
    pvVar4 = FUN_00403460(*(void **)((int)param_1 + 100),0x10800002,4,0x7400051,0,1,0x33,10000,
                          (void *)0x1);
...
LAB_0047d8a9:
        ...
        uVar2 = FUN_005f50e0((int)param_1 + 0x44);
        if (iVar8 <= (int)(uint)uVar2) goto LAB_0047d8a9;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_0047d90b;
