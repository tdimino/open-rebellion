...
int __thiscall FUN_00531d20(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar3 = *(int *)((int)this + 0x94);
      if (iVar3 != *(int *)(iVar2 + 0x94)) {
        *(int *)((int)this + 0x94) = *(int *)(iVar2 + 0x94);
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
            local_4 = (**(code **)(*(int *)this + 0x238))
                                (iVar3,*(undefined4 *)((int)this + 0x94),param_1);
          }
        }
      }
    }
