...
void __thiscall FUN_0042ec90(void *this,void *param_1)

{
  ...
  if (pvStack_14 != (void *)0x0) {
    do {
      puStack_10 = (undefined4 *)FUN_00618b70(0x50);
      uStack_4 = 0;
      if (puStack_10 == (undefined4 *)0x0) {
        piVar2 = (int *)0x0;
      }
      else {
        piVar2 = FUN_00473fd0(puStack_10);
      }
      uStack_4 = 0xffffffff;
      if (piVar2 != (int *)0x0) {
        piVar2[0x13] = *(int *)((int)this + 0x10);
