...
void * __thiscall FUN_005a4e50(void *this,uint param_1,int param_2)

{
  ...
  if (*piVar4 == 0) {
    ...
    uVar6 = *(uint *)(*(int *)((int)this + 0x5c) + 0x18);
    pvVar5 = (void *)FUN_0059ed70();
    uVar6 = FUN_005a02c0(pvVar5,uVar6);
    if (uVar6 != 0xffffffff) {
      iVar7 = FUN_005aaf90();
      iVar8 = 1;
    ...
    if (CONCAT31(extraout_var,bVar1) == 0) {
      ...
      pvVar5 = (void *)FUN_0059ed70();
      uVar6 = FUN_005a02c0(pvVar5,uVar6);
      iVar7 = (**(code **)(*(int *)(*(int *)((int)this + 0x5c) + 0x80) + 0xc))();
      if ((iVar7 == 0) && (uVar6 != 0xffffffff)) {
        iVar7 = FUN_005aaf90();
        iVar8 = 1;
        if (*(int *)(iVar7 + 0x9ec) == 0) {
          uVar6 = uVar6 + 0x2a;
