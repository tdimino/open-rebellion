...
int __thiscall FUN_004ee350(void *this,int param_1,void *param_2)

{
  ...
  if ((iVar3 != 0) && (sVar1 = *(short *)((int)this + 0x96), sVar1 != param_1)) {
    *(short *)((int)this + 0x96) = (short)param_1;
    ...
    FUN_004f04f0(pvVar4,pvVar5);
    (**(code **)(*(int *)this + 0x330))((int)sVar1,(int)*(short *)((int)this + 0x96),param_2);
  }
  return iVar3;
}
