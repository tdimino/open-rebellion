...
void __thiscall FUN_0042f5b0(void *this,void *param_1)

{
  ...
  for (piVar3 = (int *)thunk_FUN_005f5060((int)this); piVar3 != (int *)0x0;
      piVar3 = (int *)piVar3[4]) {
    local_8 = (uint)piVar3[0xb] >> 0x18;
    FUN_005f4db0(pvVar1,&local_8);
    uStack_4 = (**(code **)(*piVar3 + 0x14))();
    FUN_005f4db0(pvVar1,&uStack_4);
