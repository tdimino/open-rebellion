...
void * __thiscall FUN_004b6b70(void *this,void *param_1)
  ...
  if (pvVar4 != (void *)0x0) {
    ...
    if (sVar3 == 1) {
      ...
      if (!bVar2) {
        ...
        if ((((pvVar4 != (void *)0x0) && ((*(uint *)((int)pvVar4 + 0x38) & 0xa00) == 0)) &&
            (pvVar8 = *(void **)((int)this + 0xc),
            *(int *)((int)pvVar8 + 0x164) <= *(int *)((int)pvVar4 + 0x58))) &&
           (*(int *)((int)pvVar8 + 0x168) <= *(int *)((int)pvVar4 + 0x5c))) {
          pvVar6 = FUN_0041a460(pvVar8,(undefined4 *)(*(int *)((int)this + 0x10) + 0x34),0,0,0,0,0,
                                0x700201,(void *)0x1);
          pvVar8 = (void *)((int)this + 0x18);
          FUN_00435790(pvVar8,(int)pvVar6);
          puVar7 = (undefined4 *)FUN_004357b0(pvVar8,&local_18);
          local_4._0_1_ = 2;
          FUN_004f26d0(&local_1c,puVar7);
    ...
    if (!bVar2) {
      ...
      if ((pvVar4 != (void *)0x0) && ((*(byte *)((int)pvVar4 + 0x30) & 4) != 0)) {
        ...
        FUN_00435790(pvVar4,(int)puVar7);
        puVar7 = (undefined4 *)FUN_004357b0(pvVar4,&local_18);
        local_4._0_1_ = 5;
        FUN_004f26d0(&local_1c,puVar7);
        local_4 = CONCAT31(local_4._1_3_,1);
        FUN_00619730();
