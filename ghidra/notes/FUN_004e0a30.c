...
int * __thiscall FUN_004e0a30(void *this,uint *param_1)
  ...
  if (bVar1) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (pvVar3 == (void *)0x0) {
        ...
        pvVar3 = FUN_004f5b10(pvVar3,(undefined4 *)((int)this + 0x50),0);
      }
