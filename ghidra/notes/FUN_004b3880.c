...
void __thiscall FUN_004b3880(void *this,uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar1) {
    ...
    if ((char)param_1 != '\0') {
      ...
      pvVar3 = FUN_0041a340(*(void **)((int)this + 0xc),
                            ...
                            &DAT_00000002);
      FUN_00435790(this_00,(int)pvVar3);
      puVar5 = FUN_004357b0(this_00,&param_1);
      local_4 = 3;
      FUN_004f26d0(this_01,puVar5);
      local_4 = 0xffffffff;
      FUN_00619730();
      FUN_005f58b0(this_00);
      puVar5 = (undefined4 *)0x4;
  ...
  FUN_00619730();
  if (bVar1) {
    FUN_004af1c0(this,this_01,param_2,local_1c,(uint)puVar5);
  }
  ExceptionList = local_c;
  return;
}
