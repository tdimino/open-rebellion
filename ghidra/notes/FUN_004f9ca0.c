...
int __thiscall FUN_004f9ca0(void *this,void *param_1)

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (((*(uint *)(iVar3 + 0x24) ^ uVar1) & 0xc0) != 0) {
        FUN_00540670(this,*(uint *)(iVar3 + 0x24) >> 6 & 3);
        iVar3 = FUN_004fd3d0();
        if (iVar3 != 0) {
          iVar3 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar3 != 0) {
            iVar5 = (**(code **)(*(int *)this + 0x158))
                              (uVar1 >> 6 & 3,*(uint *)((int)this + 0x24) >> 6 & 3,param_1);
          }
        }
      }
    }
