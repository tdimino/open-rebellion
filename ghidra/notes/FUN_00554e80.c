...
uint __thiscall FUN_00554e80(void *this,int *param_1,uint *param_2,uint *param_3,int *param_4)

{
  ...
  {
    if ((((param_1[9] ^ *(uint *)((int)pvVar1 + 0x24)) & 0xc0) == 0) &&
       ((*(byte *)((int)pvVar1 + 0x88) & 0x20) == 0)) {
