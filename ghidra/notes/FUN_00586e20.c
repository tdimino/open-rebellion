...
int __cdecl FUN_00586e20(uint param_1,void *param_2,undefined4 *param_3)

{
  ...
  *param_3 = 0;
  ...
  if ((*(int *)(param_1 + 0xc) != 0) && (iVar2 != 0)) {
    ...
    FUN_00619730();
    if (bVar1) {
      uVar3 = *(uint *)(*(int *)(param_1 + 0x38) + 0xac) & 1;
      if ((uVar3 == 0) || (*(int *)(*(int *)(param_1 + 0x14) + 0x90) != 0)) {
        if (uVar3 != 0) {
          ExceptionList = pvStack_c;
          return iVar2;
        }
        if (*(int *)(*(int *)(param_1 + 0x14) + 0x94) != 0) {
          ExceptionList = pvStack_c;
          return iVar2;
        }
        local_14 = 0x40;
