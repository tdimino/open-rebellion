...
int __thiscall FUN_004face0(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar2 = FUN_0053a610(0x20000,*(uint *)(iVar2 + 0x50),(uint *)((int)this + 0x50));
      if (iVar2 != 0) {
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            local_4 = (**(code **)(*this + 0x1b8))(*(uint *)((int)this + 0x50) >> 0x11 & 1,param_1);
          }
        }
      }
    }
