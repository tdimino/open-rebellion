...
int __thiscall FUN_0052b050(void *this,void *param_1)

{
  ...
  if (local_14 != 0) {
    ...
    if (iVar3 != 0) {
      piVar4 = FUN_00527c00(this_01,local_18);
      ...
      if (iVar3 != iVar1) {
        ...
        local_4 = 0;
        puVar5 = FUN_00527c00(this_01,local_10);
        local_4._0_1_ = 1;
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            local_14 = (**(code **)(*(int *)this + 0x23c))(local_18,this_00,param_1);
          }
        }
        local_4 = 0xffffffff;
        FUN_00619730();
