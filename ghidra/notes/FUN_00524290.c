...
int __thiscall FUN_00524290(void *this,void *param_1)

{
  ...
  if (local_10 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (*(int *)((int)this + 0x78) != *(int *)(iVar2 + 0x78)) {
        FUN_004f26d0(&param_1,this_00);
        local_4 = 0;
        FUN_004f26d0(this_00,(undefined4 *)(iVar2 + 0x78));
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(this_01,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
            local_10 = (**(code **)(*(int *)this + 0x24c))(&param_1,this_00,this_01);
          }
        }
        local_4 = 0xffffffff;
        FUN_00619730();
