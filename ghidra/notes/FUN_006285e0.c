...
void __cdecl FUN_006285e0(int *param_1,int *param_2)

{
  ...
  do {
    if (0 < iVar5) {
      ...
      local_10 = iVar5;
      do {
        iVar2 = FUN_00627580(*(uint *)(local_20 + -2),(uint)*puVar8 * (uint)*puVar7,
                             (uint *)(local_20 + -2));
        if (iVar2 != 0) {
          *local_20 = *local_20 + 1;
        }
