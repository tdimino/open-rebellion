...
int __thiscall FUN_00535300(void *this,void *param_1)

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (sVar1 != *(short *)(iVar3 + 100)) {
        *(short *)((int)this + 100) = *(short *)(iVar3 + 100);
        iVar3 = FUN_004fd3d0();
        if (iVar3 != 0) {
          iVar3 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar3 != 0) {
                    /* WARNING: Load size is inaccurate */
            iVar5 = (**(code **)(*this + 0x28c))
                              ((int)sVar1,(int)*(short *)((int)this + 100),param_1);
          }
        }
      }
    }
