...
undefined4 __fastcall FUN_004bc6d0(void *param_1)
  ...
  if ((*(byte *)((int)param_1 + 0x20) & 1) == 0) {
    ...
    if (iVar5 != 0) {
      ...
      pvVar6 = FUN_00403460(*(void **)((int)param_1 + 0x40),0x800002,*(uint *)((int)param_1 + 0x50),
                            0x4f4000f1,0,6,0x32,10000,(void *)0x1);
      ...
      puVar8 = FUN_00403750(*(void **)((int)param_1 + 0x40),&local_28,0x800002,
                            *(uint *)((int)param_1 + 0x50),0x4f4000f1,0,2);
    ...
    if ((*(byte *)((int)param_1 + 0x20) & 1) == 0) goto LAB_004bc9d6;
  }
  local_20 = 1;
LAB_004bc9d6:
  local_4._0_1_ = 1;
