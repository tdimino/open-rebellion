...
void __fastcall FUN_004da0d0(int param_1)
...
LAB_004da34b:
    ...
    if (bVar2) {
      ...
      if (uVar3 < 2) {
        ...
        if (pvVar4 != (void *)0x0) {
          ...
          local_4._0_1_ = 2;
          FUN_00619730();
          if ((pvVar4 != (void *)0x0) && (0 < *(int *)((int)pvVar4 + 0x60))) {
            bVar2 = true;
          }
        }
        if (!bVar2) {
  ...
  pvVar4 = FUN_00419a00(*(void **)(param_1 + 0x2c),0x80,0,0,0,0,0,0x15,(void *)0x1);
  ...
  do {
    ...
    while( true ) {
      ...
      pvVar6 = FUN_004f5940((void *)(*(int *)(param_1 + 0x2c) + 0x44),&local_4c);
      if ((pvVar6 != (void *)0x0) && (0 < *(int *)((int)pvVar6 + 0xc4))) break;
      FUN_004ece80(&local_4c);
    }
    pvVar6 = FUN_0041a340(*(void **)(param_1 + 0x2c),&local_4c,0,0,1,0x3800003,0,0x40000000,6,
                          (void *)0x1);
    ...
    while( true ) {
      ...
      if (((pvVar6 != (void *)0x0) && (0 < *(int *)((int)pvVar6 + 0x60))) &&
         (*(int *)((int)pvVar6 + 0xd8) <= local_40)) {
