...
int __thiscall FUN_004f04f0(void *this,void *param_1)

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (sVar1 != *(short *)(iVar3 + 0x96)) {
        *(short *)((int)this + 0x96) = *(short *)(iVar3 + 0x96);
        iVar3 = FUN_004fd3d0();
        if (iVar3 != 0) {
          iVar3 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar3 != 0) {
                    /* WARNING: Load size is inaccurate */
            iVar5 = (**(code **)(*this + 0x3a8))
                              ((int)sVar1,(int)*(short *)((int)this + 0x96),param_1);
          }
        }
      }
    }
