...
void * __thiscall FUN_0041ab40(void *this,uint param_1,uint param_2,uint param_3,void *param_4)

{
  ...
  if (param_4 != (void *)0x0) {
    for (this_00 = (void *)thunk_FUN_005f5060((int)this + 0x78); this_00 != (void *)0x0;
      ...
      if (((param_1 < *(uint *)((int)this_00 + 0x34)) &&
        ...
        if (pvVar3 == (void *)0x0) {
          ...
          uVar1 = *(undefined4 *)((int)this_00 + 0x34);
