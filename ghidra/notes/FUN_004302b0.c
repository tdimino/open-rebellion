...
void __thiscall FUN_004302b0(void *this,void *param_1)

{
  ...
  if (pvStack_18 != (void *)0x0) {
    do {
      puStack_10 = (undefined4 *)FUN_00618b70(0xbc);
      local_4._0_1_ = 1;
      if (puStack_10 == (undefined4 *)0x0) {
        this_00 = (undefined4 *)0x0;
      }
      else {
        this_00 = FUN_00484180(puStack_10);
      }
      local_4 = (uint)local_4._1_3_ << 8;
      if (this_00 != (undefined4 *)0x0) {
        FUN_004843f0(this_00,pvVar1,*(undefined4 *)((int)this + 0x14),
                     *(undefined4 *)((int)this + 0x18),*(undefined4 *)((int)this + 0x1c));
        FUN_00430450(this,this_00);
      }
