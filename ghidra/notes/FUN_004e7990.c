...
void __fastcall FUN_004e7990(int param_1)

{
  ...
  if (0 < (int)uVar9) {
    pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0,0,0,2,4,&DAT_00000002);
    ...
    FUN_00619730();
    if (bVar1) {
      puVar6 = FUN_00419b80(*(void **)(param_1 + 0xc),&local_30,0,0,0,0,0,2,2);
    ...
    puVar6 = FUN_004357b0(pvVar7,&local_2c);
    local_4._0_1_ = 3;
    ...
    if ((bVar1) && (iVar4 = FUN_004e5260(local_18,(int *)&local_40), iVar4 == 0)) {
      ...
      if (local_2c == (void *)0x0) {
        ...
        pvVar7 = FUN_004ecac0(local_2c,&local_40,5,0);
      }
      local_4._0_1_ = 2;
  ...
  if (local_3c < (int)local_38) {
    pvVar5 = FUN_00419a00(*(void **)(param_1 + 0xc),0,0,0x80000,0,0,4,4,(void *)0x1);
    pvVar7 = (void *)(param_1 + 0x1c);
    FUN_00435790(pvVar7,(int)pvVar5);
    if (uVar8 != 0) {
      pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x80000,0,0,4,&DAT_00000002);
      FUN_00435790(pvVar7,(int)pvVar5);
      pvVar5 = FUN_00419e90(*(void **)(param_1 + 0xc),0,0,0x80000,0,0,4,&DAT_00000002);
      FUN_00435790(pvVar7,(int)pvVar5);
    }
