...
void __fastcall FUN_00482180(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  uVar3 = FUN_005f50e0(iVar1);
  if (uVar3 < 2) {
    pvVar4 = FUN_004035d0(*(void **)((int)param_1 + 100),0,2,0x80,0x47400051,0,5,0x33,10000,
                          (void *)0x1);
    this = (void *)((int)param_1 + 0x54);
    FUN_00435790(this,(int)pvVar4);
    pvVar4 = FUN_004035d0(*(void **)((int)param_1 + 100),0,2,0x80,0x47400051,0,1,0x33,10000,
                          (void *)0x1);
    FUN_00435790(this,(int)pvVar4);
...
LAB_0048228b:
        ...
        uVar3 = FUN_005f50e0(iVar1);
        if (1 < uVar3) goto LAB_0048228b;
        bVar2 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar2) goto LAB_004822e4;
