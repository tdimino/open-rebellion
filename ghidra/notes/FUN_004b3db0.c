...
void __thiscall FUN_004b3db0(void *this,uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar1) {
    pvVar3 = FUN_0041a3a0(*(void **)((int)this + 0xc),
                          (undefined4 *)(*(int *)((int)this + 0x10) + 0x34),0,0x80,0,0,0x8000000,0,
                          (void *)0x1);
    ...
    if (!bVar1) {
      pvVar3 = FUN_0041a3a0(*(void **)((int)this + 0xc),
                            (undefined4 *)(*(int *)((int)this + 0x10) + 0x34),0,0x80,0,0,0,0,
                            (void *)0x1);
      FUN_00435790(this_00,(int)pvVar3);
      puVar4 = FUN_004357b0(this_00,&param_1);
      local_4 = 1;
