...
void __fastcall FUN_005e4880(int param_1)

{
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    pvVar1 = FUN_00601880(pvVar1,(char *)&lpString_006a7f40,0x1a,7,0x61,0xd,0,0x10);
  }
  ...
  *(void **)(param_1 + 0xac) = pvVar1;
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    pvVar1 = FUN_00601880(pvVar1,(char *)&lpString_006a7f40,0xf,0xb6,0x79,0xd,0,0x10);
  }
  local_4 = 0xffffffff;
