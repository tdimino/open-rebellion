...
void __fastcall FUN_004dcc40(int param_1)

{
  ...
  local_4._0_1_ = 2;
  local_44 = 0;
  FUN_004ece80((undefined4 *)(param_1 + 0x40));
  local_40 = FUN_004dd050(param_1);
  if (local_40 < 1) {
LAB_004dcebd:
    uVar6 = *(uint *)(param_1 + 0x40) >> 0x18;
    local_24 = 0x90;
    local_20 = 0x98;
    ...
    if (bVar1) {
      ...
      FUN_004f26d0(&stack0xffffffa0,(undefined4 *)(param_1 + 0x40));
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if (local_30 == (undefined1 *)0x0) {
          ...
          pvVar5 = FUN_004ecc70(local_30,(undefined4 *)(param_1 + 0x40));
        }
        local_4._0_1_ = 2;
        if (pvVar5 != (void *)0x0) {
          FUN_004f57b0((void *)(param_1 + 0x58),pvVar5);
      ...
      bVar1 = false;
      uVar2 = FUN_005f50e0(param_1 + 0x58);
      if (uVar2 < 2) {
        pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x58);
        if (pvVar3 != (void *)0x0) {
        ...
        if (!bVar1) {
          iVar7 = FUN_0041b230(*(void **)(param_1 + 0x2c),(uint *)(param_1 + 0x48),(void *)0x2a,
                               0x10000,0x4000,2);
          if (iVar7 <= local_40) {
            *(uint *)(*(int *)(param_1 + 0x2c) + 8) = *(uint *)(*(int *)(param_1 + 0x2c) + 8) | 0x80
            ;
          }
        }
      }
  ...
  do {
    ...
    while( true ) {
      ...
      if (((pvVar5 != (void *)0x0) && (0 < *(int *)((int)pvVar5 + 0x60))) &&
        ...
        FUN_004f26d0((void *)(param_1 + 0x40),&local_48);
        local_44 = 1;
      }
