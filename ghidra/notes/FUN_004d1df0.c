...
int __fastcall FUN_004d1df0(int param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0063c028;
  local_c = ExceptionList;
  iVar4 = 0;
  ExceptionList = &local_c;
  for (this = (void *)thunk_FUN_005f5060(param_1 + 0x78); this != (void *)0x0;
  ...
  iVar4 = (((*(int *)(param_1 + 0x24) * iVar1) / 100) * 0x1e) / 100 - iVar4;
