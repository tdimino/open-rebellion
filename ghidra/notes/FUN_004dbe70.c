...
int * __fastcall FUN_004dbe70(int param_1)
  ...
  while (this != (void *)0x0) {
    ...
    if (pvVar6 != (void *)0x0) {
      ...
      if (*(int *)((int)pvVar6 + 0x60) < 1) {
        ...
        local_4 = 0xffffffff;
        FUN_00619730();
        *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) & 0xff7fffff;
        this = pvVar2;
      }
      else if ((*(uint *)((int)pvVar6 + 0x28) & 0x1000) == 0) {
        this = *(void **)((int)this + 0x10);
      }
      else if (*(int *)((int)pvVar6 + 0x60) < 2) {
        bVar3 = 1 < uVar4;
        if (bVar3) {
          puVar5 = FUN_00403040(this,local_40);
          local_4 = 2;
          FUN_004f26d0((void *)(param_1 + 0x40),puVar5);
          local_4 = 0xffffffff;
          FUN_00619730();
...
LAB_004dc028:
    ...
    local_4 = 5;
    piVar7 = FUN_004f3220(*(int *)(param_1 + 0x30),(uint *)(param_1 + 0x40));
    if (piVar7 != (int *)0x0) {
      FUN_0052c420(local_2c,piVar7,1);
      local_4._0_1_ = 6;
