...
uint __fastcall FUN_0054e970(int *param_1)

{
  ...
  if (uVar1 != 0) {
    if (local_38[0] == -1) {
      ...
      local_38[2] = 0x12;
      puStack_8._0_1_ = 1;
      uVar1 = FUN_00506850((uint *)(param_1 + 0xf),(undefined4 *)&stack0xffffffc0,
