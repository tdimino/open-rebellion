...
void __fastcall FUN_004dd120(int param_1)

{
  ...
  do {
    ...
    for (pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x58); pvVar3 != (void *)0x0;
      ...
      if ((pvVar5 != (void *)0x0) && (local_34 < *(int *)((int)pvVar5 + 0x60))) {
        if ((*(uint *)((int)pvVar5 + 0x30) & 0x10000000) != 0) {
          ...
          local_4._0_1_ = 3;
          pvVar7 = FUN_004f5940((void *)(param_1 + 0x60),puVar6);
          local_4._0_1_ = 1;
          FUN_00619730();
          if (pvVar7 == (void *)0x0) goto LAB_004dd27d;
        }
...
LAB_004dd27d:
    ...
    if (local_38 < 1) {
      ...
      while (pvVar3 != (void *)0x0) {
        ...
        local_4._0_1_ = 1;
        FUN_00619730();
        FUN_004f57b0((void *)(param_1 + 0x60),pvVar3);
        pvVar3 = pvVar5;
      }
