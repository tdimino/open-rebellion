...
void __fastcall FUN_004b4920(int param_1)

{
  ...
  if (pvVar3 != (void *)0x0) {
    ...
    iVar5 = (*(int *)((int)pvVar3 + 400) * 0xc) / 10;
    if (iVar5 < *(int *)(iVar1 + 0x164)) {
      iVar5 = *(int *)(iVar1 + 0x164);
    }
    ...
    iVar5 = ((*(int *)((int)pvVar3 + 0x198) + *(int *)((int)pvVar3 + 0x138)) * 0xc) / 10;
