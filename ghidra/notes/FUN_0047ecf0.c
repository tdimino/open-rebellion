...
void __fastcall FUN_0047ecf0(int param_1)
    ...
    if ((piVar5 != (int *)0x0) && (puVar6 != (undefined1 *)0x0)) {
      if ((*(uint *)(puVar6 + 0x2c) & 0x4000) != 0) {
        ...
        while (local_30 != 0) {
          ...
          local_4._0_1_ = 1;
          FUN_00619730();
          if (((pvVar7 != (void *)0x0) && ((*(uint *)((int)pvVar7 + 0x30) & 0x40) != 0)) &&
             ((*(uint *)((int)pvVar7 + 0x30) & 2) != 0)) {
      ...
      if ((*(uint *)(puVar6 + 0x2c) & 0x8000) != 0) {
        ...
        while (local_10 != 0) {
          ...
          if (((pvVar7 != (void *)0x0) && ((*(uint *)((int)pvVar7 + 0x38) & 1) == 0)) &&
             ((*(uint *)((int)pvVar7 + 0x38) & 0x1000000) != 0)) {
            for (pvVar7 = (void *)thunk_FUN_005f5060((int)pvVar7 + 0x48); pvVar7 != (void *)0x0;
              ...
              if (piVar5 != (int *)0x0) {
                ...
                while (local_30 != 0) {
                  ...
                  local_4._0_1_ = 8;
                  FUN_00619730();
                  if (((pvVar10 != (void *)0x0) && ((*(uint *)((int)pvVar10 + 0x30) & 0x40) != 0))
                     && ((*(uint *)((int)pvVar10 + 0x30) & 2) != 0)) {
                    puVar6 = (undefined1 *)FUN_00618b70(0x1c);
                    local_4._0_1_ = 10;
                    local_5c = puVar6;
                    if (puVar6 == (undefined1 *)0x0) {
