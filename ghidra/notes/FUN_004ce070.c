...
int * __fastcall FUN_004ce070(int param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0063b8ea;
  local_c = ExceptionList;
  pvVar8 = (void *)(param_1 + 0x74);
  local_50 = (int *)0x0;
  bVar3 = false;
  ExceptionList = &local_c;
  this = (void *)thunk_FUN_005f5060((int)pvVar8);
  while (this != (void *)0x0) {
    if (bVar3) goto LAB_004ce228;
    ...
    if (pvVar6 != (void *)0x0) {
      ...
      if (*(int *)((int)pvVar6 + 0x58) < 1) {
        ...
        local_4 = 0xffffffff;
        FUN_00619730();
        *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) & 0xffdfffff;
        this = pvVar2;
      }
      else if ((*(uint *)((int)pvVar6 + 0x28) & 0x1000) == 0) {
        this = *(void **)((int)this + 0x10);
      }
      else if (*(int *)((int)pvVar6 + 0x58) < 2) {
        bVar3 = 1 < uVar4;
        if (bVar3) {
          puVar5 = FUN_00403040(this,local_40);
          local_4 = 2;
          FUN_004f26d0((void *)(param_1 + 0x60),puVar5);
          local_4 = 0xffffffff;
          FUN_00619730();
...
LAB_004ce228:
    ...
    local_4 = 5;
    piVar7 = FUN_004f3220(*(int *)(param_1 + 0x30),(uint *)(param_1 + 0x60));
    if (piVar7 != (int *)0x0) {
      FUN_0052cab0(local_2c,piVar7,1);
      local_4._0_1_ = 6;
