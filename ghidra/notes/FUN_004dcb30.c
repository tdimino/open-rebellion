...
int * __fastcall FUN_004dcb30(int param_1)

{
  ...
  FUN_00619730();
  if ((bVar1) && ((*(uint *)(param_1 + 0x48) & 0xff000000) != 0)) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        FUN_004f26d0(piVar4 + 0x11,(undefined4 *)(param_1 + 0x48));
        piVar4[0x12] = *(int *)(param_1 + 0x4c);
      }
    }
  }
  local_4 = 0xffffffff;
