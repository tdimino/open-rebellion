...
void __fastcall FUN_0047f320(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  sVar2 = FUN_005f50e0((int)param_1 + 0x3c);
  if (sVar2 == 0) {
    pvVar3 = FUN_00403460(*(void **)((int)param_1 + 100),0x800002,0x200,0x7400051,0,1,0,10000,
                          (void *)0x1);
...
LAB_0047f456:
        ...
        sVar2 = FUN_005f50e0((int)param_1 + 0x3c);
        if (sVar2 != 0) goto LAB_0047f456;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_0047f4b4;
