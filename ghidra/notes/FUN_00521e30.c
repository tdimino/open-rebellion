...
int __thiscall FUN_00521e30(void *this,void *param_1,void *param_2)

{
  ...
  if (CONCAT31(extraout_var,bVar1) != 0) {
    ...
    if (CONCAT31(extraout_var_00,bVar2) != 0) {
      ...
      FUN_00524530(pvVar3,pvVar4);
      pvVar4 = param_2;
      pvVar3 = (void *)FUN_00539fd0(this,2);
      FUN_00524530(pvVar3,pvVar4);
      (**(code **)(*(int *)this + 0x210))(local_14,this_00,param_2);
      local_4 = 0xffffffff;
