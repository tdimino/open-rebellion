...
void __fastcall FUN_0047e270(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  ...
  if (uVar3 < 2) {
    pvVar4 = FUN_004035d0(*(void **)((int)param_1 + 100),0,2,2,0x4f400051,0x7000000,5,0x33,10000,
                          (void *)0x1);
...
LAB_0047e350:
        ...
        uVar3 = FUN_005f50e0(iVar1);
        if (1 < uVar3) goto LAB_0047e350;
        bVar2 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar2) goto LAB_0047e3a9;
