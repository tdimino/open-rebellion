...
int __thiscall FUN_00502430(void *this,void *param_1)

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (((*(uint *)(iVar3 + 100) ^ uVar1) & 0xf) != 0) {
        *(uint *)((int)this + 100) = (*(uint *)(iVar3 + 100) & 0xf ^ uVar1) & 0xf ^ uVar1;
        iVar3 = FUN_004fd3d0();
        if (iVar3 != 0) {
          iVar3 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar3 != 0) {
            iVar5 = (**(code **)(*(int *)this + 700))
                              (uVar1 & 0xf,*(uint *)((int)this + 100) & 0xf,param_1);
          }
        }
      }
    }
