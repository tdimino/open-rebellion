...
int __fastcall FUN_004e1a20(int param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0063dc38;
  local_c = ExceptionList;
  iVar4 = 0;
  ExceptionList = &local_c;
  for (this = (void *)thunk_FUN_005f5060(param_1 + 0x7c); this != (void *)0x0;
    ...
    FUN_00619730();
    if (pvVar3 != (void *)0x0) {
      iVar4 = iVar4 + *(int *)((int)pvVar3 + 0xd4);
    }
  }
  iVar1 = *(int *)(*(int *)(param_1 + 0x2c) + 0x184);
  iVar4 = (((*(int *)(param_1 + 0x24) * iVar1) / 100) * 0x14) / 100 - iVar4;
