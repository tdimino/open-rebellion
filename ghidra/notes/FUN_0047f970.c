...
undefined4 __fastcall FUN_0047f970(int param_1)

{
  ...
  *(uint *)(param_1 + 0x20) = *(uint *)(param_1 + 0x20) & 0xffffffef;
  ...
  if (bVar2) {
    ...
    if ((pvVar4 != (void *)0x0) && ((*(byte *)((int)pvVar4 + 0x2c) & 0x80) != 0)) {
  ...
  if ((*(byte *)(param_1 + 0x20) & 0x10) == 0) {
    ...
    if (pvVar4 != (void *)0x0) {
      *(uint *)((int)pvVar4 + 0x28) = *(uint *)((int)pvVar4 + 0x28) & 0xefffffff;
    }
    if (*(int *)(*(int *)(param_1 + 0x68) + 0x1c4) < 1) {
      ...
      if (local_20 == (undefined1 *)0x0) {
        pvVar6 = FUN_0041a1d0(*(void **)(param_1 + 0x68),0,0x40,0,0,0x10000000,0x4000000,(void *)0x1
                             );
        ...
        FUN_00619730();
        FUN_005f58b0(pvVar4);
        pvVar6 = FUN_0041a3a0(*(void **)(param_1 + 0x68),this_00,0,0x80,0,0,0,0,(void *)0x1);
        FUN_00435790(pvVar4,(int)pvVar6);
        puVar5 = FUN_004357b0(pvVar4,&local_20);
        local_4 = 7;
        ...
        puVar5 = FUN_00419b80(*(void **)(param_1 + 0x68),(undefined4 *)(param_1 + 0x38),0,0x40,0,0,
                              0x10000000,0x4000000,2);
        pvVar4 = (void *)(param_1 + 0x54);
      ...
      FUN_00619730();
      if (local_20 == (undefined1 *)0x0) {
        pvVar6 = FUN_0041a1d0(*(void **)(param_1 + 0x68),0,0x40,0,0,0x50000000,0x4000000,
                              &DAT_00000002);
        pvVar4 = (void *)(param_1 + 0x54);
        FUN_00435790(pvVar4,(int)pvVar6);
        puVar5 = FUN_004357b0(pvVar4,&local_20);
        ...
        FUN_00619730();
        FUN_005f58b0(pvVar4);
        pvVar6 = FUN_0041a460(*(void **)(param_1 + 0x68),this_00,0,0x80,0,0,0x8000000,0,(void *)0x1)
        ;
        FUN_00435790(pvVar4,(int)pvVar6);
        puVar5 = FUN_004357b0(pvVar4,&local_20);
        local_4 = 3;
        ...
        FUN_00619730();
        FUN_005f58b0(pvVar4);
        pvVar6 = FUN_0041a460(*(void **)(param_1 + 0x68),this_00,0,0x80,0,0,0x8000000,0,
                              &DAT_00000002);
        FUN_00435790(pvVar4,(int)pvVar6);
        puVar5 = FUN_004357b0(pvVar4,&local_20);
        local_4 = 1;
    ...
    if ((bVar2) &&
       (pvVar4 = FUN_004f5940((void *)(*(int *)(param_1 + 0x68) + 0x44),this_00),
       pvVar4 != (void *)0x0)) {
      *(uint *)((int)pvVar4 + 0x28) = *(uint *)((int)pvVar4 + 0x28) | 0x10000000;
