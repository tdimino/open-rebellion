...
int __thiscall FUN_004f0be0(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar2 = FUN_0053a610(1,*(uint *)(iVar2 + 0xac),(uint *)((int)this + 0xac));
      if (iVar2 != 0) {
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
            local_4 = (**(code **)(*(int *)this + 0x3c4))(*(uint *)((int)this + 0xac) & 1,param_1);
          }
        }
      }
    }
