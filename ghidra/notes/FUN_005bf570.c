...
void __thiscall FUN_005bf570(void *this,void *param_1)

{
  ...
  FUN_005ce630((void *)((int)this + *(int *)((int)this + 0x9ec) * 0xc + 0x938),param_1);
  FUN_005ce7b0((void *)((int)this + *(int *)((int)this + 0x9ec) * 0xc + 0x938),local_14);
