...
int __fastcall FUN_004b3110(void *param_1)
...
LAB_004b32d1:
  ...
  pvVar3 = FUN_0041a340(*(void **)((int)param_1 + 0xc),
                        (undefined4 *)(*(int *)((int)param_1 + 0x10) + 0x34),0,0,0x24,0,0,0x700200,8
                        ,&DAT_00000002);
  pvVar5 = (void *)((int)param_1 + 0x18);
  local_24 = pvVar5;
  FUN_00435790(pvVar5,(int)pvVar3);
  pvVar3 = FUN_0041a340(*(void **)((int)param_1 + 0xc),
                        (undefined4 *)(*(int *)((int)param_1 + 0x10) + 0x34),0,0,0x24,0,0,0x700200,
                        0x21,(void *)0x1);
  FUN_00435790(pvVar5,(int)pvVar3);
