...
int * __fastcall FUN_004c70e0(int param_1)
  ...
  if (bVar1) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (pvVar3 == (void *)0x0) {
        ...
        pvVar3 = FUN_004f5b10(pvVar3,(undefined4 *)(param_1 + 0x40),0);
      }
