...
int __thiscall FUN_00524610(void *this,void *param_1)

{
  ...
  if (local_18 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      bVar1 = FUN_004f4430(this_00,iVar2 + 0x8c);
      if (CONCAT31(extraout_var_00,bVar1) != 0) {
        FUN_004f4390(local_14,(int)this_00);
        local_4 = 0;
        FUN_004f43b0(this_00,(void *)(iVar2 + 0x8c));
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
            local_18 = (**(code **)(*(int *)this + 0x25c))(local_14,this_00,param_1);
          }
        }
        local_4 = 0xffffffff;
