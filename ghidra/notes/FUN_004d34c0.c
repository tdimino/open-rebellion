...
undefined4 __fastcall FUN_004d34c0(int param_1)

{
  ...
  FUN_00619730();
  FUN_005f58b0(pvVar5);
  pvVar3 = FUN_0041a340(*(void **)(param_1 + 0x2c),this,0,0,1,2,0,0x40000,0x35,(void *)0x1);
  FUN_00435790(pvVar5,(int)pvVar3);
  puVar4 = FUN_004357b0(pvVar5,&local_1c);
  local_4 = 1;
  FUN_004f26d0(this,puVar4);
  ...
  if (bVar2) {
    ...
    if ((pvVar5 != (void *)0x0) && (0 < *(int *)((int)pvVar5 + 0x11c))) {
      ExceptionList = local_c;
      return 1;
    }
  }
