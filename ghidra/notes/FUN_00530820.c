...
uint __thiscall FUN_00530820(void *this,void *param_1,undefined4 *param_2)

{
  ...
  this_00 = param_1;
  local_4 = 0xffffffff;
  puStack_8 = &LAB_006454c7;
  local_c = ExceptionList;
  uVar6 = 1;
  if (((*(byte *)((int)param_1 + 0x60) & 2) == 0) && (*(int *)((int)param_1 + 0x58) == 1)) {
    param_1 = (void *)0x0;
    ExceptionList = &local_c;
    iVar2 = FUN_0052fb80(this,(uint *)&param_1,param_2);
    uVar6 = 0;
    if (iVar2 != 0) {
      if (param_1 == (void *)0x0) {
        ...
        if (puVar3 != (undefined4 *)0x0) {
          if (puVar3[3] == 0) {
            ...
            puVar3[5] = uVar5;
            uVar6 = FUN_0052fbd0(this,(int)puVar3,puVar1);
          }
        }
      }
      else {
