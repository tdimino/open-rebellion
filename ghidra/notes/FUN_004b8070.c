...
undefined4 __fastcall FUN_004b8070(int param_1)

{
  ...
  if (bVar2) {
    ...
    if (pvVar4 != (void *)0x0) {
      ...
      if (((uVar3 & 1) == 0) || ((*(byte *)((int)pvVar4 + 0x28) & 2) != 0)) {
        *(uint *)((int)pvVar4 + 0x30) = *(uint *)((int)pvVar4 + 0x30) & 0xfffaffff;
        FUN_00433e30((int)pvVar4);
        FUN_004ece80((undefined4 *)(*(int *)(param_1 + 0x10) + 0x40));
      }
      else {
        if ((uVar3 & 0x10000) == 0) {
          *(uint *)((int)pvVar4 + 0x30) = uVar3 | 0x50000;
          FUN_00433e30((int)pvVar4);
        }
        local_20 = 1;
      }
  ...
  if (!bVar2) {
    ...
    if (bVar2) {
      ...
      uVar7 = local_20;
      if (pvVar4 != (void *)0x0) {
        *(uint *)((int)pvVar4 + 0x30) = *(uint *)((int)pvVar4 + 0x30) | 0x50000;
        FUN_00433e30((int)pvVar4);
        uVar7 = 1;
      }
    }
