...
void __thiscall FUN_004724a0(void *this,int *param_1,uint *param_2,uint param_3)

{
  ...
  if (param_1 == (int *)0x0) {
    ...
    if (param_2 == (uint *)0x0) {
      ...
      iVar10 = *(int *)((int)this + 0x184) + 1;
      *(int *)((int)this + 0x184) = iVar10;
    ...
    if (pvVar6 == (void *)0x0) {
      ...
      iVar4 = *(int *)((int)this + 0x184) + 1;
      local_4 = CONCAT31(local_4._1_3_,3);
      *(int *)((int)this + 0x184) = iVar4;
