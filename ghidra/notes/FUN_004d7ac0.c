...
undefined4 __fastcall FUN_004d7ac0(int param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0063c9e8;
  local_c = ExceptionList;
  local_2c = 0;
  pvVar7 = (void *)(param_1 + 0x6c);
  bVar4 = false;
...
joined_r0x004d7afa:
  do {
    if ((this == (void *)0x0) || (bVar3 = false, bVar4)) {
      if (bVar4) {
        this_00 = FUN_004f3220(*(int *)(param_1 + 0x30),(uint *)(param_1 + 0x50));
        if ((this_00 != (int *)0x0) &&
    ...
    if (bVar3) {
      ...
      if (pvVar6 == (void *)0x0) {
        ...
        if (((*(byte *)((int)pvVar6 + 0x30) & 1) != 0) &&
           (uVar2 = *(uint *)((int)pvVar6 + 0x28), (uVar2 & 0x2000000) != 0)) {
          if (((0 < *(int *)((int)pvVar6 + 0x60)) && ((uVar2 & 0x800) != 0)) && ((uVar2 & 3) == 0))
          {
            bVar4 = true;
          }
          this = *(void **)((int)this + 0x10);
          goto joined_r0x004d7afa;
        }
        *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) & 0xfdffffff;
