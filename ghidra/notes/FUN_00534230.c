...
int __thiscall FUN_00534230(void *this,int *param_1,void *param_2)

{
  ...
  if (CONCAT31(extraout_var,bVar3) != 0) {
    ...
    if (*(int *)((int)this + 0x68) != *param_1) {
      ...
      FUN_00535400(pvVar4,pvVar5);
      pvVar5 = pvVar2;
      pvVar4 = (void *)FUN_00539fd0(this,2);
      FUN_00535400(pvVar4,pvVar5);
      (**(code **)(*(int *)this + 0x23c))(&param_1,this_00,pvVar2);
      local_4 = 0xffffffff;
      FUN_00619730();
    }
  }
