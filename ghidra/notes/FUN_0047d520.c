...
void __fastcall FUN_0047d520(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffe;
  ...
  if (uVar2 < 2) {
    pvVar3 = FUN_00403460(*(void **)((int)param_1 + 100),0x800002,4,0x4f400051,0,5,0x33,10000,
                          (void *)0x1);
    this = (void *)((int)param_1 + 0x54);
    FUN_00435790(this,(int)pvVar3);
    pvVar3 = FUN_00403460(*(void **)((int)param_1 + 100),0x800002,4,0x4f400051,0,1,0x33,10000,
                          (void *)0x1);
    FUN_00435790(this,(int)pvVar3);
...
LAB_0047d67c:
        ...
        uVar2 = FUN_005f50e0((int)param_1 + 0x3c);
        if (1 < uVar2) goto LAB_0047d67c;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_0047d6da;
