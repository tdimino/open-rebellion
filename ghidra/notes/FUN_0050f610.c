...
int __thiscall FUN_0050f610(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != *(int *)(iVar2 + 0x74)) {
        *(int *)((int)this + 0x74) = *(int *)(iVar2 + 0x74);
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          iVar2 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar2 != 0) {
                    /* WARNING: Load size is inaccurate */
            local_4 = (**(code **)(*this + 0x278))(iVar3,*(undefined4 *)((int)this + 0x74),param_1);
          }
        }
      }
    }
