...
void __thiscall FUN_004c3bb0(void *this,int *param_1,int *param_2)
...
LAB_004c3d7c:
  ...
  FUN_00619730();
  if (bVar1) {
    *(int *)(*(int *)((int)this + 0x168) + 0x50) = DAT_006b28cc + 10;
    ExceptionList = local_c;
    return;
  }
LAB_004c4369:
