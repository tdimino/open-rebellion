...
int __thiscall FUN_00550de0(void *this,int param_1,int param_2,void *param_3)

{
  ...
  local_4 = 1;
  iVar2 = FUN_00550af0((int)this + 0x128,param_1 + 4,param_2,local_44);
  if (iVar2 != 0) {
