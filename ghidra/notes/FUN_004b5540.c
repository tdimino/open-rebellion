...
void __thiscall FUN_004b5540(void *this,uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar1) {
    ...
    if (((0x8f < *this_01 >> 0x18) && (*this_01 >> 0x18 < 0x98)) ||
       (param_1 = (uint *)CONCAT31(param_1._1_3_,1), *(int *)((int)this + 4) != 2)) {
