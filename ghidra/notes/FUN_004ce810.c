...
void __fastcall FUN_004ce810(int param_1)

{
  ...
  local_40 = FUN_004cec80(param_1);
  if (local_40 < 1) {
LAB_004cea8a:
    uVar6 = *(uint *)(param_1 + 0x60) >> 0x18;
    local_24 = 0x90;
    local_20 = 0x98;
    ...
    if (bVar1) {
      ...
      FUN_004f26d0(&stack0xffffffa0,(undefined4 *)(param_1 + 0x60));
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if (local_30 == (undefined1 *)0x0) {
          ...
          pvVar5 = FUN_004ecc70(local_30,(undefined4 *)(param_1 + 0x60));
        }
        local_4._0_1_ = 2;
        if (pvVar5 != (void *)0x0) {
          FUN_004f57b0((void *)(param_1 + 0x74),pvVar5);
      ...
      bVar1 = false;
      uVar2 = FUN_005f50e0(param_1 + 0x74);
      if (uVar2 < 2) {
        pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x74);
        if (pvVar3 != (void *)0x0) {
        ...
        if (!bVar1) {
          iVar7 = FUN_0041b230(*(void **)(param_1 + 0x2c),(uint *)(param_1 + 100),(void *)0x2a,
                               0x4000,0x4000,2);
          if (iVar7 <= local_40) {
            *(uint *)(*(int *)(param_1 + 0x2c) + 8) = *(uint *)(*(int *)(param_1 + 0x2c) + 8) | 0x10
            ;
          }
        }
      }
  ...
  do {
    ...
    while( true ) {
      ...
      if (((pvVar5 != (void *)0x0) && (0 < *(int *)((int)pvVar5 + 0x58))) &&
        ...
        FUN_004f26d0((void *)(param_1 + 0x60),&local_48);
        local_44 = 1;
      }
