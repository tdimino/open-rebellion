...
void __fastcall FUN_00480110(void *param_1)

{
  ...
  *(uint *)((int)param_1 + 0x20) = *(uint *)((int)param_1 + 0x20) & 0xfffffffd;
  ...
  if ((int)(uint)uVar2 < iVar8) {
    pvVar4 = FUN_00403460(*(void **)((int)param_1 + 100),0x10800002,0x100,0x7400051,0,1,0x33,10000,
                          (void *)0x1);
    ...
    if (local_18 != (undefined1 *)0x0) {
      puVar6 = FUN_00403750(*(void **)((int)param_1 + 100),(undefined4 *)((int)param_1 + 0x38),
                            0x10800002,0x100,0x7400051,0,2);
...
LAB_0048029f:
        ...
        uVar2 = FUN_005f50e0((int)param_1 + 0x44);
        if (iVar8 <= (int)(uint)uVar2) goto LAB_0048029f;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_00480301;
