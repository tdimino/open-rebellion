...
int __fastcall FUN_004cec80(int param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0063ba28;
  local_c = ExceptionList;
  iVar4 = 0;
  ExceptionList = &local_c;
  for (this = (void *)thunk_FUN_005f5060(param_1 + 0x74); this != (void *)0x0;
    ...
    FUN_00619730();
    if (pvVar3 != (void *)0x0) {
      iVar4 = iVar4 + *(int *)((int)pvVar3 + 0xd0);
    }
  }
