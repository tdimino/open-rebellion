...
void __fastcall FUN_004e15b0(int param_1)
...
LAB_004e182a:
    ...
    if (bVar1) {
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        local_4._0_1_ = 2;
        if (pvVar5 != (void *)0x0) {
          FUN_004f57b0((void *)(param_1 + 0x7c),pvVar5);
      ...
      bVar1 = false;
      uVar2 = FUN_005f50e0(param_1 + 0x7c);
      if (uVar2 < 2) {
        pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x7c);
        if (pvVar3 != (void *)0x0) {
        ...
        if (!bVar1) {
          iVar7 = FUN_0041b230(*(void **)(param_1 + 0x2c),(uint *)(param_1 + 0x5c),(void *)0x2a,
                               0x8000,0x4000,2);
          if (iVar7 <= local_40) {
            *(uint *)(*(int *)(param_1 + 0x2c) + 8) = *(uint *)(*(int *)(param_1 + 0x2c) + 8) | 0x20
            ;
          }
        }
      }
  ...
  do {
    ...
    pvVar5 = FUN_0041a340(*(void **)(param_1 + 0x2c),&local_4c,0,0,1,0x400003,0,0x40000000,5,
                          (void *)0x1);
