...
void __fastcall FUN_005cf680(int param_1)

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  ...
  fStack_30 = *pfVar4 - *pfVar2;
  fStack_28 = pfVar4[1] - pfVar2[1];
  fStack_2c = pfVar4[2] - pfVar2[2];
  ...
  fVar6 = (float10)fcos((float10)_DAT_0066d070 * (float10)_DAT_0066d094);
  fVar7 = (float10)fsin((float10)_DAT_0066d070 * (float10)_DAT_0066d094);
  fVar1 = fStack_38 - pfVar2[2];
  fStack_40 = (fStack_40 - *pfVar2) * _DAT_0066d07c;
  fStack_38 = (float)(fVar6 * (float10)fVar1 - fVar7 * (float10)(fStack_3c - pfVar2[1])) *
              _DAT_0066d07c;
  fStack_3c = ((float)fVar7 * fVar1 + (float)fVar6 * (fStack_3c - pfVar2[1])) * _DAT_0066d07c;
  uStack_34 = _DAT_0066d08c;
