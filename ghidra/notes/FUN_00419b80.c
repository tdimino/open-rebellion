...
FUN_00419b80(void *this,undefined4 *param_1,uint param_2,uint param_3,uint param_4,uint param_5,
...

{
  ...
  if (bVar2) {
    ...
    pvVar6 = FUN_0041bd90((void *)((int)this + 0x44));
    if (pvVar6 != (void *)0x0) {
      local_1c = (short)*(undefined4 *)((int)pvVar6 + 0x40);
      sStack_1a = (short)((uint)*(undefined4 *)((int)pvVar6 + 0x40) >> 0x10);
      ...
      local_28 = param_1;
      if (param_1 != (undefined4 *)0x0) {
        pvVar6 = (void *)thunk_FUN_005f5060((int)this + 0x44);
        sVar3 = sStack_1a;
        for (; pvVar6 != (void *)0x0; pvVar6 = *(void **)((int)pvVar6 + 0x10)) {
          if ((((param_2 & *(uint *)((int)pvVar6 + 0x24)) == param_2) &&
              ((param_5 & *(uint *)((int)pvVar6 + 0x24)) == 0)) &&
             (((param_3 & *(uint *)((int)pvVar6 + 0x28)) == param_3 &&
              ((((param_6 & *(uint *)((int)pvVar6 + 0x28)) == 0 &&
                ((param_4 & *(uint *)((int)pvVar6 + 0x2c)) == param_4)) &&
               ((param_7 & *(uint *)((int)pvVar6 + 0x2c)) == 0)))))) {
            local_14 = (short)*(undefined4 *)((int)pvVar6 + 0x40);
            sStack_12 = (short)((uint)*(undefined4 *)((int)pvVar6 + 0x40) >> 0x10);
            ...
            if (pvVar8 == (void *)0x0) {
              ...
              puVar9 = FUN_00403040(pvVar6,&param_8);
              local_2c = local_2c | 1;
