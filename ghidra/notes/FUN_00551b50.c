...
uint __thiscall FUN_00551b50(void *this,uint *param_1,uint *param_2,int *param_3,void *param_4)

{
  ...
  if (!bVar2) {
    if (param_3[1] == -1) {
      uVar1 = FUN_00552000(this,param_1,param_3);
    }
    bVar2 = uVar1 == 0;
  }
  if ((!bVar2) && (param_3[1] == -1)) {
