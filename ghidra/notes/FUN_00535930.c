...
int __thiscall FUN_00535930(void *this,void *param_1)

{
  ...
  if (local_4 != 0) {
    ...
    if (iVar3 != 0) {
      iVar2 = FUN_0053a610(2,*(uint *)(iVar2 + 0x78),(uint *)((int)this + 0x78));
      if (iVar2 != 0) {
        iVar2 = FUN_004fd3d0();
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            local_4 = (**(code **)(*this + 0x2a8))(*(uint *)((int)this + 0x78) >> 1 & 1,param_1);
          }
        }
      }
    }
