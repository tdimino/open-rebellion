...
void __fastcall FUN_00483410(int *param_1)

{
  ...
  if ((int)(uint)uVar2 < iVar3) {
    pvVar4 = FUN_00403460((void *)param_1[0x19],0x10800002,0x10,0x7400051,0,1,0x33,10000,(void *)0x1
                         );
    this = param_1 + 0x15;
    ...
    FUN_00619730();
    if (bVar1) {
      puVar5 = FUN_00403750((void *)param_1[0x19],param_1 + 0xe,0x10800002,0x10,0x7400051,0,2);
...
LAB_00483561:
        ...
        uVar2 = FUN_005f50e0((int)(param_1 + 0x11));
        iVar3 = (**(code **)(*param_1 + 0x44))();
        if (iVar3 <= (int)(uint)uVar2) goto LAB_00483561;
        bVar1 = true;
      }
      local_4 = local_4 & 0xffffff00;
      FUN_00619730();
      if (!bVar1) goto LAB_004835bf;
