...
int __thiscall FUN_004f0340(void *this,void *param_1)

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (sVar1 != *(short *)(iVar3 + 0x90)) {
        *(short *)((int)this + 0x90) = *(short *)(iVar3 + 0x90);
        iVar3 = FUN_004fd3d0();
        if (iVar3 != 0) {
          iVar3 = FUN_004fd600(param_1,*(uint *)((int)this + 0x24) >> 4 & 3);
          if (iVar3 != 0) {
            iVar5 = (**(code **)(*(int *)this + 0x39c))
                              ((int)sVar1,(int)*(short *)((int)this + 0x90),param_1);
          }
        }
      }
    }
