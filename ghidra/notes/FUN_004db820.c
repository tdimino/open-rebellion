...
int * __fastcall FUN_004db820(uint param_1)

{
  ...
  if (bVar2) {
    ...
    FUN_004f26d0(&stack0xffffff80,(uint *)(param_1 + 0x40));
    pvVar4 = FUN_00403d30((void *)(iVar8 + 0x2c));
    uVar3 = local_60;
    if (pvVar4 != (void *)0x0) {
      piVar5 = FUN_004f3220(*(int *)(local_60 + 0x30),(uint *)(param_1 + 0x40));
      if (piVar5 != (int *)0x0) {
