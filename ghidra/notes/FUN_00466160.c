...
void __thiscall FUN_00466160(void *this,WPARAM param_1,LPARAM param_2)

{
  ...
  case 0x26:
    ...
    return;
  case 0x28:
    iVar2 = (**(code **)(**(int **)(*(int *)((int)this + 0x150) + 0xa0) + 8))();
    if (iVar2 != 0) {
      SetFocus(*(HWND *)(*(int *)((int)this + 0x150) + 0x18));
      PostMessageA(*(HWND *)(*(int *)((int)this + 0x150) + 0x18),0x100,param_1,param_2);
      return;
    }
  }
  return;
