...
void __fastcall FUN_004e1b00(int param_1)

{
  ...
  do {
    ...
    for (pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x7c); pvVar3 != (void *)0x0;
      ...
      if ((pvVar5 != (void *)0x0) && (local_34 < *(int *)((int)pvVar5 + 0x5c))) {
        if ((*(uint *)((int)pvVar5 + 0x30) & 0x10000000) != 0) {
          ...
          local_4._0_1_ = 3;
          pvVar7 = FUN_004f5940((void *)(param_1 + 0x84),puVar6);
          local_4._0_1_ = 1;
          FUN_00619730();
          if (pvVar7 == (void *)0x0) goto LAB_004e1c60;
        }
...
LAB_004e1c60:
    ...
    if (local_38 < 1) {
      for (pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x84); pvVar3 != (void *)0x0;
          pvVar3 = *(void **)((int)pvVar3 + 0x10)) {
        puVar4 = FUN_00403040(pvVar3,local_24);
        iVar1 = *(int *)(param_1 + 0x2c);
        local_20 = &stack0xffffffb0;
      ...
      while (pvVar3 != (void *)0x0) {
        ...
        local_4._0_1_ = 1;
        FUN_00619730();
        FUN_004f57b0((void *)(param_1 + 0x84),pvVar3);
        pvVar3 = pvVar5;
      }
