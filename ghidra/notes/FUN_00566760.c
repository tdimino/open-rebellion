...
int __fastcall FUN_00566760(int *param_1)

{
  ...
  if (iVar1 != 0) {
    if (local_38[0] == -1) {
      ...
      local_38[2] = 0x12;
      puStack_8._0_1_ = 1;
      iVar1 = FUN_00506d00((uint *)(param_1 + 0xf),(undefined4 *)&stack0xffffffc0,
