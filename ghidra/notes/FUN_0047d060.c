...
undefined4 __fastcall FUN_0047d060(int param_1)
  ...
  *(uint *)(param_1 + 0x20) = *(uint *)(param_1 + 0x20) & 0xffffffef;
  if ((*(byte *)(param_1 + 0x20) & 1) == 0) {
    ...
    if (bVar2) {
      ...
      if ((pvVar4 != (void *)0x0) && ((*(byte *)((int)pvVar4 + 0x2c) & 0x20) != 0)) {
    ...
    FUN_00619730();
    if (bVar2) {
      puVar5 = FUN_00419b80(*(void **)(param_1 + 0x68),(undefined4 *)(param_1 + 0x38),0,0x10,0,0,0,0
                            ,2);
      ...
      FUN_00619730();
      FUN_005f58b0(pvVar4);
      puVar5 = FUN_0041a400(*(void **)(param_1 + 0x68),this,(undefined4 *)(param_1 + 0x38),0,0x20,0,
      ...
      pvVar6 = FUN_00419a00(*(void **)(param_1 + 0x68),0,0x10,0,0,0,0,0x3d,(void *)0x1);
      pvVar4 = (void *)(param_1 + 0x54);
      ...
      FUN_00619730();
      FUN_005f58b0(pvVar4);
      pvVar6 = FUN_0041a340(*(void **)(param_1 + 0x68),this,0,0x20,0,0,0,0,0,(void *)0x1);
      FUN_00435790(pvVar4,(int)pvVar6);
      puVar5 = FUN_004357b0(pvVar4,&local_14);
      local_4 = 3;
      FUN_004f26d0(this,puVar5);
