...
int __thiscall FUN_004f07f0(void *this,void *param_1)

{
  ...
  if (local_14 != 0) {
    ...
    if (iVar3 != 0) {
      piVar4 = FUN_004f0910(this_01,local_18);
      iVar3 = *(int *)((int)this + 0xa0);
      iVar1 = *piVar4;
      this_00 = (undefined4 *)((int)this + 0xa0);
      FUN_00619730();
      if (iVar3 != iVar1) {
        FUN_004f26d0(local_18,this_00);
        local_4 = 0;
        puVar5 = FUN_004f0910(this_01,local_10);
        local_4._0_1_ = 1;
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            local_14 = (**(code **)(*(int *)this + 0x3b8))(local_18,this_00,param_1);
          }
        }
        local_4 = 0xffffffff;
        FUN_00619730();
