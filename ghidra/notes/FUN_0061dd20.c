...
void __cdecl FUN_0061dd20(int param_1)

{
  ...
  ppuVar6 = (undefined **)PTR_LOOP_006ad174;
  do {
    ppuVar5 = ppuVar6;
    if (ppuVar6[4] != (undefined *)0xffffffff) {
      ...
      if ((iVar4 != 0) && (ppuVar6[6] == (undefined *)0xffffffff)) {
        ...
        if (iVar3 == 0x400) {
          FUN_0061dcc0(ppuVar6);
        }
      }
    }
    if ((ppuVar5 == (undefined **)PTR_LOOP_006ad174) || (ppuVar6 = ppuVar5, param_1 < 1)) {
      return;
    }
  } while( true );
}
