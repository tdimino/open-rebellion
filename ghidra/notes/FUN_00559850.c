...
bool __cdecl FUN_00559850(int param_1,int param_2,undefined4 *param_3,int *param_4)

{
  ...
  puVar1 = param_3;
  local_4 = 0xffffffff;
  puStack_8 = &LAB_00649930;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  *param_3 = 0;
  FUN_004fcdd0(param_4);
  bVar2 = FUN_0053e2f0((param_1 - param_2) * DAT_006bb4bc);
  ...
  this_00 = (void *)FUN_0055bed0(1,iVar3);
  if (this_00 != (void *)0x0) {
