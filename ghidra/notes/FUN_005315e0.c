...
int __thiscall FUN_005315e0(void *this,void *param_1)

{
  ...
  if (local_20 != 0) {
    ...
    if (iVar2 != 0) {
      piVar3 = (int *)FUN_0041bde0(this_01,local_1c);
      this_00 = (undefined4 *)((int)this + 0x58);
      local_4 = 0;
      ...
      if (CONCAT31(extraout_var_00,bVar1) != 0) {
        ...
        local_4 = 1;
        puVar4 = (undefined4 *)FUN_0041bde0(this_01,local_14);
        local_4._0_1_ = 2;
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            local_20 = (**(code **)(*this + 0x210))(local_1c,this_00,param_1);
          }
        }
        local_4 = 0xffffffff;
        FUN_00619730();
