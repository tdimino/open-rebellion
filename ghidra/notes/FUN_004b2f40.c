...
int __fastcall FUN_004b2f40(int param_1)

{
  ...
  if ((pvVar2 == (void *)0x0) || (*(int *)((int)pvVar2 + 0x80) < 1)) {
LAB_004b30d9:
    local_4 = 0xffffffff;
    FUN_00619730();
    ExceptionList = local_c;
  ...
  pvVar3 = FUN_0041a340(*(void **)(param_1 + 0xc),(undefined4 *)(*(int *)(param_1 + 0x10) + 0x34),0,
                        0,2,0,0,0x100208,0xf,(void *)0x1);
  pvVar5 = (void *)(param_1 + 0x18);
  local_20 = pvVar5;
  FUN_00435790(pvVar5,(int)pvVar3);
  puVar4 = FUN_004357b0(pvVar5,&local_1c);
  local_4._0_1_ = 1;
  ...
  do {
    ...
    do {
      ...
      if (pvVar5 != (void *)0x0) {
        iVar6 = FUN_004ae440((int)pvVar2,(int)pvVar5);
        if (iVar6 != 0) {
          local_24 = 1;
          *(uint *)((int)pvVar5 + 0x30) = *(uint *)((int)pvVar5 + 0x30) | 0x1000000;
          FUN_004f26d0((void *)((int)pvVar2 + 0x2c),&local_28);
          *(uint *)((int)pvVar2 + 0x38) = *(uint *)((int)pvVar2 + 0x38) | 0x80000000;
        }
      }
    } while (local_24 != 0);
    puVar4 = FUN_004357b0(local_20,&local_1c);
    local_4._0_1_ = 2;
    FUN_004f26d0(&local_28,puVar4);
  } while( true );
}
