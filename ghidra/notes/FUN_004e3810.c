...
int __fastcall FUN_004e3810(int param_1)

{
  ...
  if (bVar3) {
    ...
    if ((this_00 != (int *)0x0) && (pvVar6 != (void *)0x0)) {
      pvVar5 = (void *)FUN_00509670(this_00,1);
      if (pvVar5 != (void *)0x0) {
        ...
        *(int *)(param_1 + 0x58) = iVar2;
        ...
        puVar7 = FUN_004025b0(pvVar5,(uint *)&local_18);
        local_4 = 2;
    ...
    if (local_1c != 0) {
      pvVar6 = FUN_004f5940((void *)(param_1 + 0x60),puVar1);
      if (pvVar6 == (void *)0x0) {
        iVar2 = *(int *)(param_1 + 0x2c);
        ...
        if (pvVar6 != (void *)0x0) {
          ...
          if (local_14 == (void *)0x0) {
            ...
            pvVar5 = FUN_004ecc70(local_14,puVar1);
          }
          local_4 = 0xffffffff;
          if (pvVar5 != (void *)0x0) {
            FUN_004f57b0((void *)(param_1 + 0x60),pvVar5);
            *(uint *)((int)pvVar6 + 0x28) = *(uint *)((int)pvVar6 + 0x28) | 0x1000000;
