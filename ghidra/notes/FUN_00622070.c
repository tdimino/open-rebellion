...
uint __cdecl FUN_00622070(uint param_1)

{
  ...
  if (DAT_006be840 == 0) {
    ...
    if ((int)param_1 < 0x100) {
      if (DAT_006af3ac < 2) {
        uVar2 = (byte)PTR_DAT_006af1a0[param_1 * 2] & 1;
      }
      else {
        uVar2 = FUN_0061f330(param_1,1);
      }
      if (uVar2 == 0) {
        return uVar1;
      }
    ...
    iVar4 = FUN_00620ea0(DAT_006be840,0x100,(char *)&param_1,pWVar3,(LPWSTR)local_8,3,0,1);
    if (iVar4 == 0) {
      return uVar1;
    }
    if (iVar4 == 1) {
