...
void __fastcall FUN_004cc360(int param_1)

{
  ...
  do {
    ...
    for (pvVar3 = (void *)thunk_FUN_005f5060(param_1 + 0x78); pvVar3 != (void *)0x0;
      ...
      local_4._0_1_ = 1;
      FUN_00619730();
      if ((pvVar5 != (void *)0x0) && (local_34 < *(int *)((int)pvVar5 + 0x58))) {
        if ((*(uint *)((int)pvVar5 + 0x30) & 0x10000000) != 0) {
          ...
          local_4._0_1_ = 1;
          FUN_00619730();
          if (pvVar7 == (void *)0x0) goto LAB_004cc4c0;
        }
